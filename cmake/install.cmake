...
if(CMAKE_INSTALL_PREFIX_INITIALIZED_TO_DEFAULT)
  if(DEFINED PROJECT_INSTALL_DIR) # Check for CMake variable first
    ...
    if(DEFINED ENV{PROJECT_INSTALL_DIR}) # Check for environment variable then
      ...
      # If CMAKE_INSTALL_ROOT is defined, use it and append project-version
      # Also define a cached variable for when re-running CMake
      if(DEFINED CMAKE_INSTALL_ROOT)
        set(CMAKE_INSTALL_PREFIX ${CMAKE_INSTALL_ROOT}/${PROJECT_NAME}-${PROJECT_FULL_VERSION} CACHE PATH "" FORCE)
        set(AUTOGENERATED_CMAKE_INSTALL_PREFIX ON CACHE BOOL "" FORCE)
      else()
...
# For runs of CMake after the first, CMAKE_INSTALL_PREFIX is set but we may
# still need to regenerate it.
if(DEFINED CMAKE_INSTALL_ROOT AND DEFINED AUTOGENERATED_CMAKE_INSTALL_PREFIX)
  set(CMAKE_INSTALL_PREFIX ${CMAKE_INSTALL_ROOT}/${PROJECT_NAME}-${PROJECT_FULL_VERSION} CACHE PATH "" FORCE)
endif()
