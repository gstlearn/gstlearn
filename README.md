...
```
Note: If you really want to clean all files generated by CMake, you can remove *build* directory content by hand. Linux or MinGW users may use the clean_all target from the source directory.
