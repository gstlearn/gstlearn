...
cmake-python:
	@cmake -DCMAKE_BUILD_TYPE=$(FLAVOR) -DUSE_HDF5=$(USE_HDF5) -B$(BUILD_DIR) -H. $(GENERATOR) -DBUILD_PYTHON=ON

cmake-r:
	@cmake -DCMAKE_BUILD_TYPE=$(FLAVOR) -DUSE_HDF5=$(USE_HDF5) -B$(BUILD_DIR) -H. $(GENERATOR) -DBUILD_R=ON

cmake-python-r:
	@cmake -DCMAKE_BUILD_TYPE=$(FLAVOR) -DUSE_HDF5=$(USE_HDF5) -B$(BUILD_DIR) -H. $(GENERATOR) -DBUILD_PYTHON=ON -DBUILD_R=ON
