...
namespace gstlrn
{
  ...
  DbMeshStandard* DbMeshStandard::create(Id ndim,
                                         ...
                                         bool verbose)
  {
    DbMeshStandard* dbmesh = new DbMeshStandard(ndim,
                                                napexpermesh,
                                                apices,
                                                meshes,
                                                order,
  ...
  void DbMeshStandard::getCoordinatesPerMeshInPlace(Id imesh,
                                                    Id rank,
  ...
  VectorDouble DbMeshStandard::getCoordinatesPerMesh(Id imesh,
                                                     Id idim,
                                                     bool flagClose) const
  {
    VectorDouble vec;
