...
namespace gstlrn
{
  ...
  MatrixSparse PrecisionOpMultiMatrix::_prepareMatrixStationary(
    Id icov,
    const MatrixSparse* Q) const
  {
  ...
  MatrixSparse PrecisionOpMultiMatrix::_prepareMatrixNoStat(
    Id icov,
    const MatrixSparse* Q) const
  {
  ...
  Id PrecisionOpMultiMatrix::_addToDest(const constvect whitenoise, vect outv)
    const
  {
    return PrecisionOpMulti::_addToDest(whitenoise, outv);
  }

  Id PrecisionOpMultiMatrix::_addSimulateToDest(
