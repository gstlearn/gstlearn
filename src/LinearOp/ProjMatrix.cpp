...
namespace gstlrn
{
  ...
  Id ProjMatrix::_addMesh2point(const constvect inv, vect outv) const
  {
    ...
    {
      messerr("_addMesh2point: Error in the dimension of argument 'inv'(%d). "
              "It should be (%d)",
              inv.size(),
              getNApex());
      return 1;
    ...
    {
      messerr("_addMesh2point: Error in the dimension of argument 'outv'(%d). "
              "It should be (%d)",
              outv.size(),
              getNPoint());
      return 1;
  ...
  Id ProjMatrix::_addPoint2mesh(const constvect inv, vect outv) const
  {
    ...
    {
      messerr("_addPoint2mesh: Error in the dimension of argument 'inv'(%d). "
              "It should be (%d)",
              inv.size(),
              getNPoint());
      return 1;
    ...
    {
      messerr("_addPoint2mesh: Error in the dimension of argument 'outv'(%d). "
              "It should be (%d)",
              outv.size(),
              getNApex());
      return 1;
