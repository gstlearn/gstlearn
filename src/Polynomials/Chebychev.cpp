...
namespace gstlrn
{
  ...
  Id Chebychev::fit(const std::function<double(double)>& f,
                    double a,
                    double b,
                    double tol)
  {
  ...
  Id Chebychev::_countCoeffs(const std::function<double(double)>& f,
                             double x,
                             double a,
                             double b,
                             double tol) const
  ...
  void Chebychev::_fillCoeffs(const std::function<double(double)>& f,
                              double a,
                              double b)
  {
  ...
  void Chebychev::_addEvalOp(const ALinearOp* Op,
                             const constvect inv,
                             vect outv) const
  {
    VectorDouble tm1, tm2, px, tx;
  ...
  VectorDouble Chebychev::smoother(ALinearOp* Op,
  ...
  void Chebychev::smoother(ALinearOp* Op,
                           VectorDouble& ucurr,
                           const VectorDouble& rhs,
                           double lambda_max,
                           double ratiomin,
