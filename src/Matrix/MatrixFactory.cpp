...
namespace gstlrn
{
   ...
   *****************************************************************************/
  MatrixSquare*
    MatrixFactory::createMatrixSquare(const MatrixSquare* x, Id nrow)
  {
    /// TODO : use typeinfo
                                       ...
                                       bool flagKeepCols)
  {
    ...
    else if (mxrg != nullptr)
    {
      ...
      messageAbort("CreateReduce cannot be called for such matrix. This should "
                   "never happen");
                                          ...
                                          bool flagKeepCol)
  {
    ...
    return MatrixFactory::createReduce(x,
                                       localSelRows,
                                       localSelCols,
                                       flagKeepRow,
                                       flagKeepCol);
