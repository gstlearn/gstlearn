...
namespace gstlrn
{
  ...
  void MatrixSparse::resetFromArray(Id nrows,
                                    Id ncols,
                                    const double* tab,
                                    bool byCol)
  {
  ...
  void MatrixSparse::resetFromVD(Id nrows,
                                 Id ncols,
 ...
 */
  ...
  void MatrixSparse::getStats(Id* nrows,
                              Id* ncols,
                              Id* count,
  ...
  MatrixSparse* prodNormMatVec(const MatrixSparse* a,
                               const VectorDouble& vec,
                               bool transpose)
  {
  ...
  VectorInt MatrixSparse::getNonZeroRows(Id icol) const
  {
    ...
    for (Eigen::SparseMatrix<double, Eigen::RowMajor>::InnerIterator it(rowMat,
                                                                        icol);
         it;
         ++it)
    {
  ...
  Id MatrixSparse::forwardLU(const VectorDouble& b,
                             VectorDouble& x,
  ...
  bool MatrixSparse::_areIdenticalGeneral(const MatrixSparse& a,
