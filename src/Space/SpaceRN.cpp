...
namespace gstlrn
{
   ...
   */
  double
    SpaceRN::_getDistance(const SpacePoint& p1, const SpacePoint& p2, Id ispace)
      const
  {
  ...
  double SpaceRN::_getFrequentialDistance(
    const SpacePoint& p1,
    const SpacePoint& p2,
    const Tensor& tensor,
    Id ispace) const
  ...
  VectorDouble SpaceRN::_getIncrement(
    const SpacePoint& p1,
    const SpacePoint& p2,
    Id ispace) const
  {
  ...
  void SpaceRN::_getIncrementInPlace(
    const SpacePoint& p1,
    const SpacePoint& p2,
    VectorDouble& ptemp,
    Id ispace) const
  ...
  void SpaceRN::getDistancePointVectInPlace(
    const SpacePoint& p1,
