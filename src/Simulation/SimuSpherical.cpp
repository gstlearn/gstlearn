...
namespace gstlrn
{
                             ...
                             bool verbose)
  {
    ...
    set_keypair("Simsph_Spectrum_Frequencies",
                1,
    ...
    for (Id iy = 0; iy < ny; iy++)
    {
      ...
      for (Id ibf = 0; ibf < nbf; ibf++)
      {
        ...
        double t1 = ut_flegendre(static_cast<Id>(degree_loc),
                                 static_cast<Id>(order_loc),
                                 theta);
   ...
   *****************************************************************************/
  VectorDouble
    SimuSpherical::_spectrum_exponential(Model* model,
                                         const SimuSphericalParam& sphepar)
  {
    VectorDouble freqs;
    Id ifreq = 0;
