...
namespace gstlrn
{
  ...
  bool Potential::_isEnvironmentValid(DbGrid* dbout, Id nring)
  {
    ...
    const auto* covpot =
      dynamic_cast<const CovGradientAnalytic*>(_model->getCov());
    if (covpot == nullptr)
    {
   ...
   **
   *****************************************************************************/
  void Potential::_environmentManage(
    bool flag_pot,
    bool flag_grad,
    bool flag_trans,
    Id option_part)
  ...
  void Potential::_saveResultData(
    Db* db,
    Id nvar,
    double value,
  ...
  Id Potential::_buildLHS(Db* dbout, MatrixSymmetric& lhs)
  {
    ...
    for (Id ig = 0; ig < _ngrd; ig++)
    {
      ...
      {
        _calculateCovs(
          _model, true, GRD_COO(ig, 0), GRD_COO(ig, 1), GRD_COO(ig, 2),
          GRD_COO(jg, 0), GRD_COO(jg, 1), GRD_COO(jg, 2), covar, covGp, covGG);
      ...
      _calculateCovs(
        _model, true, GRD_COO(ig, 0), GRD_COO(ig, 1), GRD_COO(ig, 2),
        GRD_COO(ig, 0), GRD_COO(ig, 1), GRD_COO(ig, 2), covar, covGp, covGG);
    ...
    for (Id it = 0; it < _ntgt; it++)
    {
      ...
      {
        _calculateCovs(
          _model, true, TGT_COO(it, 0), TGT_COO(it, 1), TGT_COO(it, 2),
          GRD_COO(ig, 0), GRD_COO(ig, 1), GRD_COO(ig, 2), covar, covGp, covGG);

        _setLHS(
          lhs, TGT(it), GRX(ig),
          _setMatUV(
            TGT_VAL(it, 0), TGT_VAL(it, 1), TGT_VAL(it, 2), covGG[0], covGG[1],
            covGG[2]));
        _setLHS(
          lhs, TGT(it), GRY(ig),
          _setMatUV(
            TGT_VAL(it, 0), TGT_VAL(it, 1), TGT_VAL(it, 2), covGG[3], covGG[4],
            covGG[5]));
        _setLHS(
          lhs, TGT(it), GRZ(ig),
          _setMatUV(
            TGT_VAL(it, 0), TGT_VAL(it, 1), TGT_VAL(it, 2), covGG[6], covGG[7],
            covGG[8]));
      }
      ...
      for (Id jt = 0; jt < it; jt++)
      {
        _calculateCovs(
          _model, true, TGT_COO(it, 0), TGT_COO(it, 1), TGT_COO(it, 2),
          TGT_COO(jt, 0), TGT_COO(jt, 1), TGT_COO(jt, 2), covar, covGp, covGG);

        _setLHS(
          lhs, TGT(it), TGT(jt),
          _setMatUAV(
            covGG, TGT_VAL(it, 0), TGT_VAL(it, 1), TGT_VAL(it, 2),
            TGT_VAL(jt, 0), TGT_VAL(jt, 1), TGT_VAL(jt, 2)));
      }
      _calculateCovs(
        _model, true, TGT_VAL(it, 0), TGT_VAL(it, 1), TGT_VAL(it, 2),
        TGT_VAL(it, 0), TGT_VAL(it, 1), TGT_VAL(it, 2), covar, covGp, covGG);
      _setLHS(
        lhs, TGT(it), TGT(it),
        _setMatUAV(
          covGG, TGT_VAL(it, 0), TGT_VAL(it, 1), TGT_VAL(it, 2), TGT_VAL(it, 0),
          TGT_VAL(it, 1), TGT_VAL(it, 2))
          + _nugget_tgt);
    }
    ...
    for (Id ic1 = 0; ic1 < _nlayers; ic1++)
    {
      for (Id j1 = 1; j1 < _nbPerLayer[ic1]; j1++)
      {
        ...
        for (Id ig = 0; ig < _ngrd; ig++)
        {
          _calculateCovs(
            _model, true, GRD_COO(ig, 0), GRD_COO(ig, 1), GRD_COO(ig, 2),
            ISO_COO(ic1, 0, 0), ISO_COO(ic1, 0, 1), ISO_COO(ic1, 0, 2), covar,
            covGp, covGG);
          _calculateCovs(
            _model, true, GRD_COO(ig, 0), GRD_COO(ig, 1), GRD_COO(ig, 2),
        ...
        for (Id ic2 = 0; ic2 <= ic1; ic2++)
        {
          ...
          {
            _calculateCovs(
              _model, false, ISO_COO(ic2, j2, 0), ISO_COO(ic2, j2, 1),
              ISO_COO(ic2, j2, 2), ISO_COO(ic1, j1, 0), ISO_COO(ic1, j1, 1),
              ISO_COO(ic1, j1, 2), covar1, covGp, covGG);
            _calculateCovs(
              _model, false, ISO_COO(ic2, j2, 0), ISO_COO(ic2, j2, 1),
              ISO_COO(ic2, j2, 2), ISO_COO(ic1, 00, 0), ISO_COO(ic1, 00, 1),
              ISO_COO(ic1, 00, 2), covar2, covGp, covGG);
            _calculateCovs(
              _model, false, ISO_COO(ic2, 00, 0), ISO_COO(ic2, 00, 1),
              ISO_COO(ic2, 00, 2), ISO_COO(ic1, j1, 0), ISO_COO(ic1, j1, 1),
              ISO_COO(ic1, j1, 2), covar3, covGp, covGG);
            _calculateCovs(
              _model, false, ISO_COO(ic2, 00, 0), ISO_COO(ic2, 00, 1),
              ISO_COO(ic2, 00, 2), ISO_COO(ic1, 00, 0), ISO_COO(ic1, 00, 1),
              ISO_COO(ic1, 00, 2), covar4, covGp, covGG);
            _setLHS(
              lhs, ISC(ic1, j1), ISC(ic2, j2),
    ...
    for (Id ig = 0; ig < _ngrd; ig++)
    {
      ...
      {
        if (_extdriftEval(
              GRD_COO(ig, 0), GRD_COO(ig, 1), GRD_COO(ig, 2), dbout, &extval,
              extgrd))
          return (1);
    ...
    for (Id it = 0; it < _ntgt; it++)
    {
      ...
      if (_order >= 2)
      {
        ...
        _setLHS(lhs, DRF(3), TGT(it), 2. * TGT_COO(it, 0) * TGT_VAL(it, 0));
        _setLHS(lhs, DRF(4), TGT(it), 2. * TGT_COO(it, 1) * TGT_VAL(it, 1));
        _setLHS(lhs, DRF(5), TGT(it), 2. * TGT_COO(it, 2) * TGT_VAL(it, 2));

        /* Derivates f = xy, xz, et yz */

        _setLHS(
          lhs, DRF(6), TGT(it),
          TGT_COO(it, 1) * TGT_VAL(it, 0) + TGT_COO(it, 0) * TGT_VAL(it, 1));
        _setLHS(
          lhs, DRF(7), TGT(it),
          TGT_COO(it, 2) * TGT_VAL(it, 0) + TGT_COO(it, 0) * TGT_VAL(it, 2));
        _setLHS(
          lhs, DRF(8), TGT(it),
          TGT_COO(it, 2) * TGT_VAL(it, 1) + TGT_COO(it, 1) * TGT_VAL(it, 2));
      }
      ...
      {
        if (_extdriftEval(
              TGT_COO(it, 0), TGT_COO(it, 1), TGT_COO(it, 2), dbout, &extval,
              extgrd))
          return (1);
        _setLHS(
          lhs, EXT(iext), TGT(it),
          _setMatUV(
            TGT_VAL(it, 0), TGT_VAL(it, 1), TGT_VAL(it, 2), extgrd[0],
            extgrd[1], extgrd[2]));
      }
    }
    ...
    for (Id ic1 = 0; ic1 < _nlayers; ic1++)
    {
      for (Id j = 1; j < _nbPerLayer[ic1]; j++)
      {
        if (_order >= 1)
        {
          ...
          _setLHS(
            lhs, DRF(0), ISC(ic1, j), ISO_COO(ic1, j, 0) - ISO_COO(ic1, 0, 0));
          _setLHS(
            lhs, DRF(1), ISC(ic1, j), ISO_COO(ic1, j, 1) - ISO_COO(ic1, 0, 1));
          _setLHS(
            lhs, DRF(2), ISC(ic1, j), ISO_COO(ic1, j, 2) - ISO_COO(ic1, 0, 2));
        }
        ...
        {
          if (_extdriftEval(
                ISO_COO(ic1, j, 0), ISO_COO(ic1, j, 1), ISO_COO(ic1, j, 2),
                dbout, &extval2, extgrd))
            return (1);
          if (_extdriftEval(
                ISO_COO(ic1, 0, 0), ISO_COO(ic1, 0, 1), ISO_COO(ic1, 0, 2),
                dbout, &extval1, extgrd))
            return (1);
    ...
    MatrixDense& rhs)
  {
    ...
    {
      _calculateCovs(
        _model, flag_grad, GRD_COO(ig, 0), GRD_COO(ig, 1), GRD_COO(ig, 2),
        coor[0], coor[1], coor[2], covar, covGp, covGG);
    ...
    {
      _calculateCovs(
        _model, flag_grad, TGT_COO(it, 0), TGT_COO(it, 1), TGT_COO(it, 2),
        coor[0], coor[1], coor[2], covar, covGp, covGG);
      _setRHS(
        rhs, TGT(it), 0,
        _setMatUV(
          TGT_VAL(it, 0), TGT_VAL(it, 1), TGT_VAL(it, 2), covGp[0], covGp[1],
          covGp[2]));
      if (flag_grad)
      {
        _setRHS(
    ...
    for (Id ic = 0; ic < _nlayers; ic++)
    {
      ...
      {
        _calculateCovs(
          _model, flag_grad, ISO_COO(ic, j, 0), ISO_COO(ic, j, 1),
          ISO_COO(ic, j, 2), coor[0], coor[1], coor[2], covar1, cov1Gp, cov1GG);
        _calculateCovs(
          _model, flag_grad, ISO_COO(ic, 0, 0), ISO_COO(ic, 0, 1),
          ISO_COO(ic, 0, 2), coor[0], coor[1], coor[2], covar, covGp, covGG);
    ...
    for (Id i = 0; i < 3; i++) ccor[i] = coor[i] - center[i];
    ...
    for (Id iext = 0; iext < _next; iext++)
    {
      if (_extdriftEval(coor[0], coor[1], coor[2], dbgrid, &extval, extgrd))
        return;
  ...
  void Potential::_blankPartRHS(MatrixDense& rhs) const
  {
    ...
    for (Id i = 0; i < _nequa; i++)
    {
      ...
      _setRHS(rhs, i, 0, 0.);
      if (_flagGrad)
        for (Id igrad = 1; igrad < 4; igrad++) _setRHS(rhs, i, igrad, 0.);
    }
  }
  ...
  Id Potential::_extdriftCreateDb(DbGrid* dbout)
  {
    ...
    _dbExt = DbGrid::create(
      nx, dbout->getDXs(), x0, dbout->getAngles(), ELoadBy::COLUMN,
  ...
  Id Potential::_extdriftCreateModel()
  {
    ...
    // Covariance part
    const CovAniso* cova =
      CovAniso::createFromParam(ECov::CUBIC, _rangeExt, 1.);
  ...
  MatrixDense Potential::_extdriftBuildRHS()
  {
    ...
    for (Id iech = 0; iech < _nfull; iech++)
    {
      ...
      _calculateCovs(
        _modelExt, true, _dbExt->getCoordinate(iech, 0),
        _dbExt->getCoordinate(iech, 1), _dbExt->getCoordinate(iech, 2), 0., 0.,
        0., covar, covGp, covGG);
    ...
    VectorDouble& extgrd)
  {
    ...
    *extval = result[0];
    for (Id idim = 0; idim < _ndim; idim++) extgrd[idim] = result[1 + idim];
  ...
  void Potential::_fillDualSimulation(Id nbsimu, MatrixDense& zvals)
  {
    ...
    for (Id isimu = 0; isimu < nbsimu; isimu++)
    {
      ...
      for (Id ig = 0; ig < _ngrd; ig++)
      {
        if (_ndim >= 1)
          zvals.setValue(
            GRX(ig), isimu,
            _dbgrd->getSimvar(
              ELoc::SIMU, IAD_GRD(ig), isimu + 0 * nbsimu, 0, 0, _ndim * nbsimu,
              1)
              - GRD_VAL(ig, 0));
        if (_ndim >= 2)
          zvals.setValue(
            GRY(ig), isimu,
            _dbgrd->getSimvar(
              ELoc::SIMU, IAD_GRD(ig), isimu + 1 * nbsimu, 0, 0, _ndim * nbsimu,
              1)
              - GRD_VAL(ig, 1));
        if (_ndim >= 3)
          zvals.setValue(
            GRZ(ig), isimu,
            _dbgrd->getSimvar(
              ELoc::SIMU, IAD_GRD(ig), isimu + 2 * nbsimu, 0, 0, _ndim * nbsimu,
              1)
              - GRD_VAL(ig, 2));
      }
      ...
      for (Id it = 0; it < _ntgt; it++)
      {
        zvals.setValue(
          TGT(it), isimu,
          _dbtgt->getSimvar(ELoc::SIMU, IAD_TGT(it), isimu, 0, 0, nbsimu, 1));
      }
      ...
      for (Id ic = 0; ic < _nlayers; ic++)
        for (Id j = 1; j < _nbPerLayer[ic]; j++)
        {
          zvals.setValue(
            ISC(ic, j), isimu,
            _dbiso->getSimvar(
              ELoc::SIMU, IAD_ISO(ic, j), isimu, 0, 0, nbsimu, 1)
              - _dbiso->getSimvar(
                ELoc::SIMU, IAD_ISO(ic, 0), isimu, 0, 0, nbsimu, 1));
        }
    }
  ...
  void Potential::_calculatePoint(
    bool flag_grad,
    DbGrid* dbgrid,
    VectorDouble& zdual,
    MatrixDense& rhs,
   ...
   **
   *****************************************************************************/
  void Potential::_convertPotentialToLayer(
    Id isimu,
    const double* potval,
   ...
   **
   *****************************************************************************/
  void Potential::_estimateResult(
    bool flag_grad,
    DbGrid* dbout,
    double refpot,
    VectorDouble& zdual,
    ...
    double* potval)
  {
    ...
    for (Id iech = 0; iech < dbout->getNSample(); iech++)
    {
      ...
      if (_flagTrans) _convertPotentialToLayer(0, potval, result);
   ...
   **
   *****************************************************************************/
  void Potential::_convertDistance(
    Id ic0,
    Id j0,
    VectorDouble& zval,
    ...
    double* dist_geo)
  {
    ...
    lhs_aux = dynamic_cast<MatrixSymmetric*>(MatrixFactory::createReduceOne(
      &lhs_orig_arg, icol0, icol0, false, false));
    ...
    for (Id idim = 0; idim < _ndim; idim++) coor0[idim] = ISO_COO(ic0, 0, idim);
    ...
    {
      message(
        "Sample:%2d/%2d Iter:%2d Potential:%lf", j0 + 1, ic0 + 1, 0, result[0]);
      for (Id idim = 0; idim < _ndim; idim++) message(" %lf", coor0[idim]);
      message("\n");
    }
    ...
    for (Id iter = 0; iter < niter_max; iter++)
    {
      ...
      {
        message(
          "Sample:%2d/%2d Iter:%2d Potential:%lf", j0 + 1, ic0 + 1, iter,
          result[0]);
        for (Id idim = 0; idim < _ndim; idim++) message(" %lf", coor[idim]);
        message("\n");
      }
    }
   ...
   **
   *****************************************************************************/
  void Potential::_xvalidCalculate(
    MatrixSymmetric& lhs,
    bool flag_dist_conv,
    VectorDouble& zval,
    ...
    MatrixDense& rhs)
  {
    ...
    for (Id ic = 0; ic < _nlayers; ic++)
    {
      ...
      for (Id j = 1; j < _nbPerLayer[ic]; j++)
      {
        ...
        mes_process(
          "Potential Estimation on Iso-Potential %d of %d", j + 1, ic + 1);
        ...
        {
          message(
            "Sample %d/%d (%d): Error=%lf - Variance=%lf", j + 1, ic + 1,
      ...
      if (_verbose && number > 0)
      {
        for (Id i = 0; i < nitem; i++)
        {
          for (Id j = 0; j < 2; j++) stats[i][j] /= number;
          stats[i][1] -= stats[i][0] * stats[i][0];
          stats[i][1] = (stats[i][1] > 0) ? sqrt(stats[i][1]) : 0.;
        }
        message("\nIso-Potential #%d\n", ic + 1);
        message(
          "Cross-validation Error: Mean=%lf St. Dev.=%lf\n", stats[0][0],
          stats[0][1]);
        message(
          "Standardized Error    : Mean=%lf St. Dev.=%lf\n", stats[1][0],
          stats[1][1]);
        if (flag_dist_conv)
        {
          message(
            "Euclidean Distance    : Mean=%lf St. Dev.=%lf\n", stats[2][0],
            stats[2][1]);
          message(
            "Geodetic Distance     : Mean=%lf St. Dev.=%lf\n", stats[3][0],
            stats[3][1]);
        }
      }
    }
    ...
    MatrixDense& rhs)
  {
    ...
    for (Id iech = 0; iech < dbout->getNSample(); iech++)
    {
      ...
      for (Id isimu = 0; isimu < nbsimu; isimu++)
      {
        ...
        result[0] =
          (dbout->getSimvar(ELoc::SIMU, iech, isimu, 0, 0, nbsimu, 1)
           - result[0]);
        for (Id idim = 0; idim < ndim; idim++)
          result[1 + idim] =
            (_dbgrd->getSimvar(
               ELoc::SIMU, iech, isimu + idim * nbsimu, 0, 0, ndim * nbsimu, 1)
             - result[1 + idim]);
        ...
        if (flag_trans) _convertPotentialToLayer(isimu, potsim, result);
      ...
      for (Id ic = 0; ic < _nlayers; ic++)
      {
        for (Id j = 0; j < _nbPerLayer[ic]; j++, rank++)
        {
          ...
          if (_verbose)
          {
            ...
            if (nbsimu > 0)
              result[0] =
                _dbiso->getSimvar(ELoc::SIMU, iech, isimu, 0, 0, nbsimu, 1)
                - result[0];
        ...
        if (_verbose)
        {
          ...
          if (nbsimu > 0)
          {
            for (Id idim = 0; idim < _ndim; idim++)
              result[1 + idim] =
                (_dbgrd->getSimvar(
                   ELoc::SIMU, iech, isimu + idim * nbsimu, 0, 0,
                   _ndim * nbsimu, 1)
                 - result[1 + idim]);
          }
   ...
   **
   *****************************************************************************/
  double Potential::_evaluateRefPot(
    DbGrid* dbgrid,
    VectorDouble& zdual,
    MatrixDense& rhs)
  {
   ...
   **
   *****************************************************************************/
  void Potential::_evaluatePotential(
    DbGrid* dbgrid,
    double refpot,
    Id isimu,
    Id nbsimu,
    ...
    double* potval)
  {
    ...
    for (Id ic = 0; ic < _nlayers; ic++)
    {
      ...
      if (nbsimu > 0)
        result[0] =
          (_dbiso->getSimvar(ELoc::SIMU, ip1, isimu, 0, 0, nbsimu, 1)
           - result[0]);
...

  {
    ...
    for (Id iech = 0; iech < dbout->getNSample(); iech++)
    {
      ...
      if (!FFFF(value) && ABS(value) > eps)
        dbout->setLocVariable(ELoc::Z, iech, 0, TEST);
    }
    ...
    Id option_part)
  {
    ...
    _saveResultData(
      dbout, 1, TEST, ELoc::Z, ELoc::G, uid_out_pot, uid_out_grad);
    if (flag_save_data)
    {
      _saveResultData(
        _dbiso, 1, TEST, ELoc::UNDEFINED, ELoc::UNDEFINED, uid_iso_pot,
        uid_iso_grad);
      _saveResultData(
        _dbgrd, 1, TEST, ELoc::UNDEFINED, ELoc::UNDEFINED, uid_grd_pot,
        uid_grd_grad);
      _saveResultData(
        _dbtgt, 1, TEST, ELoc::UNDEFINED, ELoc::UNDEFINED, uid_tgt_pot,
        uid_tgt_grad);
    }
    ...
    if (_verbose) _checkData(dbout, -1, 0, refpot, zdual, rhs);
    ...
    {
      _estimateData(
        dbout, refpot, zdual, rhs, _dbiso, uid_iso_pot, uid_iso_grad);
      _estimateData(
        dbout, refpot, zdual, rhs, _dbgrd, uid_grd_pot, uid_grd_grad);
      _estimateData(
        dbout, refpot, zdual, rhs, _dbtgt, uid_tgt_pot, uid_tgt_grad);
    }
    ...
    Id nbtuba)
  {
    ...
    _saveResultData(
      dbout, nbsimu, 0., ELoc::SIMU, ELoc::UNDEFINED, uid_out_pot,
      uid_out_grad);
    _saveResultData(
      _dbiso, 2 * nbsimu, 0., ELoc::SIMU, ELoc::UNDEFINED, uid_iso_pot,
      uid_iso_grad);
    _saveResultData(
      _dbgrd, 2 * nbsimu, 0., ELoc::SIMU, ELoc::UNDEFINED, uid_grd_pot,
      uid_grd_grad);
    _saveResultData(
    ...
    /* Processing the non-conditional simulation over the iso-values */
    {
      ...
      if (situba_new.simulatePotential(
            _dbiso, _dbgrd, _dbtgt, dbout, _model, delta))
        return 1;
    }
    ...
    if (OptDbg::isReferenceDefined() || OptDbg::query(EDbg::KRIGING))
      printMatrix(
        zduals.getValues(), nbsimu, _nequa, "\n[Simu-Err] *%* [A]-1", 0, 1);
    ...
    for (Id isimu = 0; isimu < nbsimu; isimu++)
    {
      ...
      _evaluatePotential(
        dbout, refpot, isimu, nbsimu, zdual_loc, rhs,
        &potsim[isimu * _nlayers]);
    }

    // Perform the conditional simulations on the grid
    _simcond(
      dist_tempere, flag_trans, nbsimu, dbout, refpot, potsim.data(), zdual,
      zduals, rhs);
    ...
    bool verbose)
  {
    ...
    Id error = pot.kriging(
      dbout, flag_pot, flag_grad, flag_trans, flag_save_data, option_part);
    ...
    bool verbose)
  {
    ...
    pot.setVerbose(verbose);
    Id error =
      pot.simulate(dbout, dist_tempere, flag_trans, seed, nbsimu, nbtuba);
