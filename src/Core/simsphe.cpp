 ...
 **
 *****************************************************************************/
static int st_gdiscrete(int nfreq, double *freqs)
{
  double partvec, u;
 ...
 **
 *****************************************************************************/
static double* st_freq_array_realloc(double *freqs, int nfreq, int *nquloc)
{
  int nquant, newsize;
  ...
  if (nfreq >= nquant * QUANTUM)
  {
    ...
    {
      freqs = (double*) mem_realloc((char* ) freqs, sizeof(double) * newsize,
                                    0);
    }
 ...
 **
 *****************************************************************************/
static double* st_spectrum_chentsov(double tol, int nfmax, int *nfreq)
{
 ...
 **
 *****************************************************************************/
static void st_spectrum_normalize(int verbose, int nfreq, double *freqs)
{
