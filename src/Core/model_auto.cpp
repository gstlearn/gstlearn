...

{
  ...
  CovCalcMode mode(ECalcMember::LHS, true, false, -1, true);
                       ...
                       VectorDouble &ge)
{
  ...
  CovCalcMode mode = CovCalcMode(ECalcMember::LHS, true, false, -1, true);
                               ...
                               double tolsigma)
{
  ...
  VectorDouble tab(nvar * nvar);
  CovCalcMode mode(ECalcMember::LHS, true, false, icov);
  mode.setOrderVario(STRMOD->norder);
