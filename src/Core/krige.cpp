             ...
             Id nfeq)
{
  ...
  for (IECH_OUT = 0; IECH_OUT < nech; IECH_OUT++)
  {
    ...
    if (nbefore_mem != nbefore || nafter_mem != nafter || OptDbg::force())
    {
      ...
      AMatrix::prodMVInPlace(wgt_global, lhs_global, rhs_global);
                 ...
                 VectorDouble& data_var)
{
  ...
  AMatrix::prodVMInPlace(aux1, datm, tutil);
  // tutil.prodVecMatInPlace(datm, aux1);
  AMatrix::prodVMInPlace(aux2, aux1, invsig);
  ...
  for (Id iech = 0; iech < nech; iech++)
  {
    ...
    AMatrix::prodVMInPlace(aux3, s, tutil);
    ...
    AMatrix::prodVMInPlace(aux4, aux3, invsig);
                  ...
                  VectorDouble& crit)
{
  ...
  for (Id iech = ecr = 0; iech < ndat; iech++)
  {
    ...
    AMatrix::prodMVInPlace(temp_loc, invc, cs);
  ...
  for (Id iech = ecr = 0; iech < ndat; iech++)
  {
    ...
    AMatrix::prodVMInPlace(aux1, cs, temp);
                            ...
                            VectorDouble& mu)
{
  ...
  AMatrix::prodMVInPlace(mu, zmat, maux);
                         ...
                         Model* model_src)
{
  ...
  for (IECH_OUT = 0; IECH_OUT < DBOUT->getNSample(); IECH_OUT++)
  {
    ...
    AMatrix::prodMVInPlace(lambda, covpp, rhs);
