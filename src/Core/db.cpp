...
namespace gstlrn
{
   ...
   **
   *****************************************************************************/
  Id db_grid_copy_dilate(DbGrid* db1,
                         Id iatt1,
                         DbGrid* db2,
                         Id iatt2,
                         Id mode,
   ...
   **
   *****************************************************************************/
  Id index_point_to_grid(const Db* dbin,
                         Id iech,
                         Id flag_outside,
                         const DbGrid* dbout,
                         double* coor)
                           ...
                           Id flag_locnew)
  {
    ...
    else
    {
      ...
      for (Id i = 0; i < number; i++)
      {
        ...
        for (Id j = 0; j < ncur; j++)
        {
          if (locatorIdentify(strings[current[j] - 1],
                              &ref_type,
                              &ref_item,
                              &nmult))
            continue;
   ...
   **
   *****************************************************************************/
  Id db_gradient_modang_to_component(Db* db,
                                     Id ang_conv,
                                     Id iad_mod,
                                     Id iad_ang,
                                     Id iad_gx,
