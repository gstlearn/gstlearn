...
#define SWAP_INT32(x)                                                          \
  (x) = ((0x000000ff & ((x)) >> 24) | (0x0000ff00 & ((x)) >> 8)                \
   ...
   **
   *****************************************************************************/
  static void st_print_results(Id nPerTrace,
                               bool flag_surf,
                               double delta,
                               RefStats& refstats)
  {
    ...
    if (flag_surf)
      message("(Statistics are calculated taking Surface information into "
              "account)\n");
   ...
   **
   *****************************************************************************/
  static void st_refstats_update(Id iline,
                                 Id xline,
                                 double xtrace,
                                 double ytrace,
                                 RefStats& refstats)
                     ...
                     Id codefmt)
  {
    ...
    if (st_surface_identify(verbOption,
                            surf2D,
                            bot_name,
                            flag_bot,
                            &iatt_bot,
    ...
    while (1)
    {
      ...
      st_get_trace_params(&traceHead_,
                          &iline,
                          &xline,
                          &delta,
                          &xtrace,
