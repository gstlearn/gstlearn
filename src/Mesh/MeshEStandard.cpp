...
namespace gstlrn
{
  ...
  **
  *****************************************************************************/
  double MeshEStandard::getCoor(Id imesh, Id rank, Id idim) const
  {
  ...
  *****************************************************************************/
  String MeshEStandard::toString(const AStringFormat* strfmt) const
  {
    ...
    sstr << toStrTitle(0, "Standard Meshing");
   ...
   */
  MeshEStandard*
    MeshEStandard::createFromNF(const String& NFFilename, bool verbose)
  {
  ...
  MeshEStandard* MeshEStandard::createFromExternal(
    const MatrixDense& apices,
    const MatrixInt& meshes,
    bool verbose)
  {
  ...
  **
  *****************************************************************************/
  bool MeshEStandard::_coorInMesh(
  ...
  bool MeshEStandard::_deserializeAscii(std::istream& is)
  {
    Id ndim = 0;
    Id napices = 0;
    Id napexpermesh = 0;
    ...
    if (ret)
    {
      ...
      ret = ret
         && _recordReadVec<double>(is, "Apices", apices_local, napices * ndim);
      _apices = MatrixDense(napices, ndim);
  ...
  bool MeshEStandard::_serializeAscii(std::ostream& os) const
  {
    bool ret = true;
...
#ifdef HDF5
  bool MeshEStandard::deserializeH5(H5::Group& grp)
  {
  ...
  bool MeshEStandard::serializeH5(H5::Group& grp) const
  {
