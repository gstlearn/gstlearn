...
namespace gstlrn
{
  ...
  Id meshes_2D_sph_from_db(Db* db, SphTriangle* t)
  {
    ...
    if (ndim != 2)
    {
      messerr("In Spherical System, the Space Dimension of the data base Db "
              "must be 2 (%d)\n",
              ndim);
      return (1);
    }
    ...
    for (Id iech = 0; iech < nech; iech++)
    {
      ...
      GH::convertSph2Cart(db->getCoordinate(iech, 0),
