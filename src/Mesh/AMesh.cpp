...
namespace gstlrn
{
  ...
  void AMesh::getCoordinatesPerMeshInPlace(Id imesh,
                                           Id rank,
  ...
  *****************************************************************************/
   ...
   */
  void
    AMesh::getEmbeddedCoordinatesPerMeshInPlace(Id imesh,
  ...
  Id AMesh::getMeshAndInPlaceWeightsFromCoordinates(const VectorDouble& coords,
