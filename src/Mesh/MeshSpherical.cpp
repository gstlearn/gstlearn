...
namespace gstlrn
{
  ...
  *****************************************************************************/
  ...
  {
    return GH::geodeticTriangleSurface(getCoor(imesh, 0, 0),
                                       getCoor(imesh, 0, 1),
                                       getCoor(imesh, 1, 0),
                                       getCoor(imesh, 1, 1),
                                       getCoor(imesh, 2, 0),
  ...
  *****************************************************************************/
  ...
  void MeshSpherical::getEmbeddedCoorPerMesh(Id imesh,
                                             Id ic,
  ...
  bool MeshSpherical::_deserializeAscii(std::istream& is)
  {
    ...
    if (ret)
    {
      ...
      ret = ret
         && _recordReadVec<Id>(is,
                               "Meshes",
                               meshes_local,
                               nmeshes * napexpermesh);
