...
namespace gstlrn
{
  ...
  AnamEmpirical*
    AnamEmpirical::createFromNF(const String& NFFilename, bool verbose)
  {
  ...
  void
    AnamEmpirical::setDisc(const VectorDouble& zdisc, const VectorDouble& ydisc)
  {
  ...
  Id AnamEmpirical::_getStatistics(
  ...
  Id AnamEmpirical::_fitWithDilutionGaussian(const VectorDouble& tab)
  {
    ...
    if (_getStatistics(
          tab, &number, &dmean, &dmean2, &dmini, &dmaxi, &variance))
      return 1;
    Id nech = static_cast<Id>(tab.size());
  ...
  Id AnamEmpirical::_fitWithDilutionLognormal(const VectorDouble& tab)
  {
    ...
    {
      messerr(
        "The Anamorphosis by Lognormal Dilution is not compatible with "
  ...
  Id
    AnamEmpirical::fitFromArray(const VectorDouble& tab, const VectorDouble& wt)
  {
    DECLARE_UNUSED(wt);
  ...
  bool AnamEmpirical::_serializeAscii(std::ostream& os) const
  {
    bool ret = true;
    ret = ret && AnamContinuous::_serializeAscii(os);
    ret =
      ret && _recordWrite<Id>(os, "Number of Discretization lags", getNDisc());
  ...
  bool AnamEmpirical::_deserializeAscii(std::istream& is)
  {
    Id ndisc = 0;
    double sigma2e = TEST;
    ...
    ret =
      ret && _recordRead<double>(is, "Experimental Error Variance", sigma2e);
...
#ifdef HDF5
  bool AnamEmpirical::deserializeH5(H5::Group& grp)
  {
  ...
  bool AnamEmpirical::serializeH5(H5::Group& grp) const
  {
