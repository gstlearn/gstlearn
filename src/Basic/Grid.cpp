...
double Grid::indiceToCoordinate(int idim0,
                                const std::span<const int> indice,
...
int Grid::indiceToRank(const std::span<const int> indice) const
{
 ...
 */
void Grid::rankToIndice(int rank, std::span<int> indices, bool minusOne) const
{
