...
namespace gstlrn
{
   ...
   */
  VectorDouble
    Grid::getCoordinatesByIndice(const VectorInt& indice,
                                 bool flag_rotate,
  ...
  void Grid::getCoordinatesByCornerInPlace(VectorDouble& coor,
   ...
   */
  VectorDouble
    Grid::getCellCoordinatesByCorner(Id node,
                                     const VectorInt& shift,
                                     const VectorDouble& dxsPerCell) const
  {
    VectorDouble coor(_nDim);
   ...
   */
  void Grid::getCoordinatesByRankInPlace(VectorDouble& coor,
                                         Id rank,
  ...
  double Grid::indiceToCoordinate(Id idim0,
  ...
  void Grid::rankToCoordinatesInPlace(Id rank,
                                      VectorDouble& coor,
                                      const VectorDouble& percent) const
  {
    rankToIndice(rank, _iwork0);
                                      ...
                                      double eps) const
  {
    ...
    {
      messerr("Argument 'indice' should have the correct size. Output argument "
              "'indice' not modified.");
      return -1;
    }
  ...
  Id Grid::coordinateToRank(const VectorDouble& coor,
                            bool centered,
                            double eps) const
  {
  ...
  void Grid::iteratorInit(const VectorInt& order)
  {
    ...
    else
    {
      ...
      for (Id idim = 0; idim < _nDim; idim++)
      {
        ...
        if (!found)
        {
          messerr("When provided, 'order' should contain all Space dimensions. "
                  "Iterator cancelled.");
          _iter = 0;
          _counts = {};
          _order = VectorInt();
