...
namespace gstlrn
{
  ...
  double LawStable::law_stable_unilateral_exptilt(const double alpha,
                                                  const double lambda,
  ...
  double LawStable::_unilateral_exptilt_singleRejection(const double alpha,
                                                        const double lambda)
  {
    double val = 0.0;
    Id nbr = 0.0;
  ...
  double LawStable::_unilateral_exptilt_doubleRejection(const double alpha,
                                                        const double lambda)
  {
    /*
    ** ------------------------------------------------------------
