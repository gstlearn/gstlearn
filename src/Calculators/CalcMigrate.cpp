...
namespace gstlrn
{
                             ...
                             VectorDouble& dvect)
  {
    ...
    {
      double dd2 = st_distance_modify(dbgrid,
                                      ig,
                                      dbpoint,
                                      ip,
                                      dvect,
   ...
   **
   *****************************************************************************/
  static void st_expand(Id flag_size,
                        DbGrid* dbgrid,
                        VectorDouble& tab1,
                        VectorInt& indg0,
                        VectorInt& indg,
  ...
  bool CalcMigrate::_check()
  {
    ...
    {
      messerr("Argument 'dist_type'(%d)  should be 1 (for L1 distance) or 2 "
              "(for L2 distance",
              _distType);
      return false;
    }
                                                 ...
                                                 bool flagCap)
  {
    ...
    for (Id isurf = 0; isurf < nsurf; isurf++)
      if (interpolateVariableToPoint(dbgrid,
                                     iatts[isurf],
                                     xp,
                                     yp,
                                     zp,
      ...
      if (db1->isGrid())
      {
        ...
        if (flag_fill)
        {
          ...
          else
          {
            ...
            if (_interpolateGridToPoint(db1grid,
                                        db2grid,
                                        iatt1,
                                        distType,
                                        dmax,
      ...
      else
      {
        ...
        if (flag_fill)
        {
          ...
          if (flag_ball)
          {
            ...
            if (_expandPointToPointBall(db1,
                                        db2grid,
                                        iatt1,
                                        distType,
                                        dmax,
