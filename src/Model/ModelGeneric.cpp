...
namespace gstlrn
{
  ...
  void ModelGeneric::fitNew(const Db* db,
                            ...
                            bool reml)
  {
    AModelOptim* amopt = AModelOptimFactory::create(this,
                                                    db,
                                                    vario,
                                                    dbmap,
                                                    constraints,
  ...
  bool ModelGeneric::deserializeH5(H5::Group& grp)
  {
    ...
    if (varioNumber != 2)
    {
      messerr("ModelGeneric::deserializeH5: Unsupported version %d",
              varioNumber);
      return false;
    }
  ...
  bool ModelGeneric::serializeH5(H5::Group& grp) const
  {
    ...
    Id varioNumber = 2;
    ret = ret
       && SerializeHDF5::writeValue(modelG,
                                    "Version Number",
                                    static_cast<Id>(varioNumber));
