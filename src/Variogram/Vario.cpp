...
#define WT(ijvar, ipadir) wt[IJDIR(ijvar, ipadir)]
  ...
  void Vario::_setListBiTargetCheck()
  {
    ...
    for (Id idir = 0, ndir = getNDir(); idir < ndir; idir++)
    {
      ...
      {
        BiTargetCheckGeometry* bipts =
          BiTargetCheckGeometry::create(_db->getNDim(),
                                        dirparam.getCodirs(),
      ...
      if (_varioparam.hasDate())
      {
        ...
        BiTargetCheckDate* bipts =
          BiTargetCheckDate::create(_varioparam.getDate(idate, 0),
      ...
      {
        BiTargetCheckCode* bipts =
          BiTargetCheckCode::create(dirparam.getOptionCode(),
                                    dirparam.getTolCode());
        _addBiTargetCheck(bipts);
        _biPtsPerDirection++;
      }
  ...
  Id Vario::prepare(const ECalcVario& calculType,
                    bool flag_ergodic,
                    bool defineList)
  {
    if (_nVar <= 0)
                          ...
                          bool asSymmetric)
  {
    ...
    else
    {
      ...
      for (Id i = 0; i < static_cast<Id>(varcols.size()); i++)
      {
        ...
        {
          messerr("Argument 'varcols' is incorrect: item(%d)=%d should lie "
                  "between 0 and %d",
                  i + 1,
                  selvars[i],
                  nvar_in);
    ...
    else
    {
      ...
      for (Id i = 0; i < ndir_in; i++)
      {
        ...
        {
          messerr("Argument 'dircols' is incorrect: item(%d)=%d should lie "
                  "between 0 and %d",
                  i + 1,
                  seldirs[i],
                  ndir_in);
    ...
    for (Id idir = 0; idir < getNDir(); idir++)
    {
      ...
      for (Id ilag = 0, nlag = getNLag(idir); ilag < nlag; ilag++)
      {
        ...
        setGgByIndex(idir,
                     ilag,
                     1.
                       - anamH->invertVariance(cvv - getGgByIndex(idir, ilag)));
      }
    }
   ...
   **
   *****************************************************************************/
  Id Vario::regularizeFromModel(const Model& model,
                                const VectorDouble& ext,
                                const VectorInt& ndisc,
                                const VectorDouble& angles,
   ...
   **
   *****************************************************************************/
  Id Vario::regularizeFromDbGrid(Model* model,
                                 const Db& db,
                                 const CovCalcMode* mode)
  {
      ...
      for (Id ilag = 0; ilag < getNLag(idir); ilag++)
      {
        ...
        for (Id ivar = 0; ivar < nvar; ivar++)
          for (Id jvar = 0; jvar <= ivar; jvar++)
          {
            ...
            setGgByIndex(idir,
                         iad,
                         c00tab.getValue(ivar, jvar)
                           - covtab.getValue(ivar, jvar));
            setHhByIndex(idir, iad, dist);
            setSwByIndex(idir, iad, 1);
          }
      }
  ...
  String Vario::toString(const AStringFormat* strfmt) const
  {
    ...
    sstr << toStrMatrix("Variance-Covariance Matrix",
                        VectorString(),
                        VectorString(),
                        0,
                        _nVar,
  ...
  void Vario::updateLocalMeans(Id idir,
                               Id iad,
                               Id ivar,
                               Id jvar,
                               double w1,
   ...
   */
  VectorDouble Vario::getGgVec(Id idir,
                               Id ivar,
                               Id jvar,
                               bool asCov,
                               bool flagNorm,
  ...
  void Vario::setGgVec(Id idir, Id ivar, Id jvar, const VectorDouble& gg)
  {
    ...
    if (nlag != static_cast<Id>(gg.size()))
    {
      ...
      messerr("The length of your input vector (gg) is %d",
  ...
  void Vario::setHhVec(Id idir, Id ivar, Id jvar, const VectorDouble& hh)
  {
    ...
    {
      messerr("The number of values expected is %d", nlag);
      messerr("The length of your input vector (hh) is %d",
  ...
  void Vario::setSwVec(Id idir, Id ivar, Id jvar, const VectorDouble& sw)
  {
    ...
    {
      messerr("The number of values expected is %d", nlag);
      messerr("The length of your input vector (sw) is %d",
  ...
  bool Vario::_serializeAscii(std::ostream& os) const
  {
    ...
    for (Id idir = 0; ret && idir < getNDir(); idir++)
    {
      ...
      {
        for (Id idim = 0;
             ret && idim < static_cast<Id>(dirparam.getNDim()) && ret;
             idim++)
          ret = ret
             && _recordWrite(os,
                             "",
                             static_cast<double>(dirparam.getGrincr(idim)));
                 ...
                 const VectorDouble& hh)
  {
    ...
    {
      messerr("The arguments (%ld) do not have correct dimension (%ld)",
              static_cast<Id>(gg.size()),
              size);
      return 1;
    }
  ...
  VectorDouble Vario::setGgs(Id idir,
                             Id ivar,
                             Id jvar,
  ...
  Id Vario::_updateUK(Db* db, Vario_Order* vorder)
  {
    ...
    for (Id iter = 0; iter < _niter_UK; iter++)
    {
      ...
      if (_verbose)
      {
        ...
        _model->display();
        printMatrix(_DRFXGX.getValues(),
                    _DRFXGX.getNRows(),
                    _DRFXGX.getNCols(),
                    "Drift Coefficients Matrix",
                    0,
                    1);
      }
  ...
  {
    return (0.5
            * (db->getLocVariable(ELoc::V, iech, 0)
   ...
   **
   *****************************************************************************/
  void Vario::_setAVarioResult(Id iech1,
                               Id iech2,
                               Id nvar,
                               Id idir,
                               Id ilag,
   ...
   **
   *****************************************************************************/
  void Vario::_printDebug(Id iech1,
                          Id iech2,
                          Id ivar,
                          Id jvar,
                          Id ilag,
                          ...
                          double value)
  {
    message("Samples: %d/%d - Variables: %d/%d - Weight: %lf - Lag: %d - "
            "Variogram: %lf\n",
            iech1 + 1,
            iech2 + 1,
            ivar + 1,
  ...
  bool Vario::_isCompatible(const Db* db) const
  {
    if (db->getNDim() != getNDim() || db->getNLoc(ELoc::Z) != getNVar())
    {
      ...
      messerr("Data Base: NDIM=%d NVAR=%d",
              db->getNDim(),
              db->getNLoc(ELoc::Z));
   ...
   **
   *****************************************************************************/
  void Vario::getExtension(Id ivar,
                           Id jvar,
                           Id idir0,
                           Id flag_norm,
                           Id flag_vars,
   ...
   **
   *****************************************************************************/
  Id Vario::_calculateVarioVectSolution(Db* db,
                                        Id idir,
                                        Id ncomp,
                                        const Id* rindex)
  {
        ...
        for (Id ilag = 0; ilag < getNLagTotal(idir); ilag++, ecr++)
        {
          ...
          else
          {
            ...
            if (getFlagAsym() && ilag < getNLag(idir))
              setHhByIndex(idir,
                           iad,
                           -ABS(getHhByIndex(idir,
                                             iad))); // turn distance negative
            if (getCalcul() != ECalcVario::COVARIOGRAM)
      ...
      for (Id ivar = 0; ivar < nvar; ivar++)
        for (Id jvar = 0; jvar < ivar; jvar++)
        {
          for (Id i = 0; i < getNLag(idir); i++, ecr++)
          {
            ...
            setGgByIndex(idir,
                         j,
                         -getGgByIndex(idir, j) / getGgByIndex(idir, j0));
          }
        }
    }
    else if (getCalcul() == ECalcVario::TRANS2)
        ...
        for (Id jvar = 0; jvar < ivar; jvar++)
        {
          for (Id i = 0; i < getNLag(idir); i++, ecr++)
          {
            ...
            setGgByIndex(idir,
                         j,
                         getGgByIndex(idir, j)
                           / sqrt(getGgByIndex(idir, j1)
                                  * getGgByIndex(idir, j2)));
          }
        }
    }
  }
    ...
    for (Id iech = iiech = 0; iech < db->getNSample(); iech++)
    {
      ...
      for (Id il = 0; il < nbfl; il++)
      {
        ...
        for (Id jl = 0; jl < nbfl; jl++)
          matdrf.setValue(il,
                          jl,
                          matdrf.getValue(il, jl) + drfloc[il] * drfloc[jl]);
      }
      iiech++;
    }
   ...
   **
   *****************************************************************************/
  double Vario::_linear_interpolate(Id n,
   ...
   **
   *****************************************************************************/
  Id Vario::computeGeometryMLayers(Db* db,
                                   VectorInt& seltab,
  ...
  bool Vario::serializeH5(H5::Group& grp) const
  {
    ...
    ret = ret
       && SerializeHDF5::writeValue(varioparamG,
                                    "Scale",
    ...
    if (flag_calcul)
      ret = ret
         && SerializeHDF5::writeVec(varioG,
                                    "Variances",
                                    getVarMatrix().getValues());
                            ...
                            bool verbose)
  {
    ...
    if (ndir > 1)
      varioparam = VarioParam::createMultiple(ndir,
                                              nlag,
                                              dlag,
                                              toldis,
                                              0.,
      ...
      varioparam = VarioParam::createSeveral2D(angles,
                                               nlag,
                                               dlag,
                                               toldis,
                                               tolang,
      ...
      varioparam = VarioParam::createOmniDirection(nlag,
                                                   dlag,
                                                   toldis,
                                                   0,
                                                   0,
                            ...
                            bool verbose)
  {
    ...
    {
      varioparam = VarioParam::createMultipleFromGrid(dbgrid,
                                                      nlag,
                                                      0.,
                                                      VectorDouble(),
                                                      space);
