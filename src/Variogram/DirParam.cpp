...
namespace gstlrn
{
  ...
  std::vector<DirParam> DirParam::createMultiple(
    Id ndir,
    Id nlag,
    double dlag,
    double toldis,
  ...
  std::vector<DirParam> DirParam::createSeveral2D(
   ...
   */
  std::vector<DirParam> DirParam::createMultipleInSpace(
    Id nlag,
    double dlag,
    const ASpaceSharedPtr& space)
  {
