...
double AVario::_evaluateResultVariogram(Id icase, double z11, double z21, double z12, double z22)
{
  DECLARE_UNUSED(icase);
  return (z12 - z11) * (z22 - z21) / 2.;
}

double AVario::_evaluateResultMadogram(Id icase, double z11, double z21, double z12, double z22)
{
  DECLARE_UNUSED(icase);
  return sqrt(ABS((z12 - z11) * (z22 - z21))) / 2.;
}

double AVario::_evaluateResultRodogram(Id icase, double z11, double z21, double z12, double z22)
{
  DECLARE_UNUSED(icase);
  return pow(ABS((z12 - z11) * (z22 - z21)), 0.25) / 2.;
}

double AVario::_evaluateResultCovariance(Id icase, double z11, double z21, double z12, double z22)
{
  if (icase == 1)
    return z11 * z22;
  return z12 * z21;
...
double AVario::_evaluateResultOrder4(Id icase, double z11, double z21, double z12, double z22)
{
  DECLARE_UNUSED(icase);
...
void AVario::_evaluateSymmetric(
  Db* db,
  Id nvar,
  Id iech1,
  Id iech2,
  ...
  for (Id ivar = 0; ivar < nvar; ivar++)
  {
    ...
    for (Id jvar = 0; jvar <= ivar; jvar++)
    {
      ...
      _setAVarioResult(iech1, iech2, nvar, idir, ilag, ivar, jvar, 0,
                       scale, w1, w2, TEST, TEST, dist, value);
    }
  }
}

void AVario::_evaluateASymmetric(
  Db* db,
  Id nvar,
  Id iech1,
  Id iech2,
    ...
    for (Id jvar = 0; jvar <= ivar; jvar++)
    {
      ...
      if (!FFFF(z22))
      {
        ...
        _setAVarioResult(iech1, iech2, nvar, idir, ilag, ivar, jvar, orient,
                         scale, w1, w2, z11, z22, dist, value);
      }
      if (!FFFF(z21) && do_asym)
      {
        double value = (this->*_evaluateResult)(-1, z11, z21, z12, z22);
        _setAVarioResult(iech1, iech2, nvar, idir, ilag, ivar, jvar, -orient,
                         scale, w1, w2, z21, z12, dist, value);
      }
    }
  }
}
