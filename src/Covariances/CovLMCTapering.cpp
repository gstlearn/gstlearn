...
namespace gstlrn
{
  ...
  {
    static Def_Tapering DEF_TAPES[] = {{"Spherical", 3, _tape_spherical},
                                       {"Cubic", 3, _tape_cubic},
  ...
  double _tape_penta(double h)
  {
    ...
    if (h < 1)
      cov =
        1.
        - h2
            * (22. / 3. - h2 * (33. - h * (77. / 2. - h2 * (33. / 2. - h2 * (11. / 2. - 5. / 6. * h2)))));
  ...
  double _tape_wendland2(double h)
  {
    ...
    if (h < 1)
      cov =
        1
        - h2
            * ((28. / 3.) - h2 * (70 - h * ((448. / 3.) - h * (140 - h * (64 - h * (35. / 3.))))));
    return (cov);
  }
  ...
  double CovLMCTapering::eval0(Id ivar, Id jvar, const CovCalcMode* mode) const
  {
    double cov0 = CovAnisoList::eval0(ivar, jvar, mode);
    return cov0;
  }

  double CovLMCTapering::_eval(
    const SpacePoint& p1,
    const SpacePoint& p2,
    Id ivar,
    Id jvar,
    const CovCalcMode* mode) const
  {
    ...
    else
    {
      ...
      cov0 = CovAnisoList::_eval(
        p1, p1, ivar, jvar, &modeloc); // or eval0 if stationary
    }
