...
namespace gstlrn
{
  ...
  void CovAnisoList::makeTensorNoStatDb(Id icov,
  ...
  void CovAnisoList::makeRangeNoStatFunctional(Id icov,
  ...
  void CovAnisoList::makeScaleNoStatFunctional(Id icov,
                                               const AFunctional* func,
                                               Id idim)
  {
    if (!_isCovarianceIndexValid(icov)) return;
  ...
  void CovAnisoList::makeAngleNoStatFunctional(Id icov,
                                               const AFunctional* func,
                                               Id idim)
  {
    if (!_isCovarianceIndexValid(icov)) return;
  ...
  void CovAnisoList::makeTensorNoStatFunctional(Id icov,
                                                const AFunctional* func,
                                                Id idim,
                                                Id jdim)
  {
