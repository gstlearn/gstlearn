...
namespace gstlrn
{
  ...
  String CovAnisoList::toString(const AStringFormat* /*strfmt*/) const
  {
    ...
    if (isStationary())
    {
      ...
      {
        sstr << toStrMatrix(
          "Total Sill", VectorString(), VectorString(), 0, getNVar(), getNVar(),
  ...
  CovAniso CovAnisoList::extractCova(Id icov) const
  {
    ...
    if (covaniso == nullptr) return CovAniso(CovContext(), ECov::NUGGET);
  ...
  const CovAnisoList*
    CovAnisoList::createReduce(const VectorInt& validVars) const
  {
  ...
  void CovAnisoList::makeTensorNoStatDb(
    Id icov,
  ...
  void CovAnisoList::makeRangeNoStatFunctional(
    Id icov,
  ...
  void CovAnisoList::makeScaleNoStatFunctional(
    Id icov,
    const AFunctional* func,
    Id idim)
  {
  ...
  void CovAnisoList::makeAngleNoStatFunctional(
    Id icov,
    const AFunctional* func,
    Id idim)
  {
  ...
  void CovAnisoList::makeTensorNoStatFunctional(
    Id icov,
    const AFunctional* func,
    Id idim,
    Id jdim)
  ...
  void CovAnisoList::appendParams(
