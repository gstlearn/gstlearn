...
void CovAnisoList::_loadAndAddEvalCovMatBiPointInPlace(MatrixSquareGeneral& mat,
                                                       const SpacePoint& p1,
                                                       const SpacePoint& p2,
                                                       const CovCalcMode* mode) const
{
...
// void CovAnisoList::evalCovLHS(MatrixSquareSymmetric &mat,
//                           SpacePoint &pwork1,
//                           SpacePoint &pwork2,
//                           const Db* db, 
//                           const CovCalcMode *mode) const
...
// void CovAnisoList::evalCovRHS(MatrixSquareSymmetric &mat,
//                           SpacePoint &pwork1,
