...
namespace gstlrn
{
  ...
  bool CalcKrigingSimpleCase::_run()
  {
    ...
    KrigingSystemSimpleCase ksys(
      getDbin(), getDbout(), getModelGeneric(), getNeigh());
    ...
    auto nbthread = static_cast<I32>(OptCustom::query(
      "ompthreads", 1)); // TODO : would like to use more threads
