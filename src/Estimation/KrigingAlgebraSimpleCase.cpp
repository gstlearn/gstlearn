...
namespace gstlrn
{
  ...
  Id KrigingAlgebraSimpleCase::_needStdv()
  {
    ...
    else
    {
      ...
      AMatrix::linearCombinationInPlace(_Stdv,
                                        0.,
                                        1.,
                                        *_Sigma00,
                                        -1.,
  ...
  void KrigingAlgebraSimpleCase::_printMatrix(const String& name,
                                              const AMatrix* mat)
  {
  ...
  void KrigingAlgebraSimpleCase::_printVector(const String& name,
                                              const VectorDouble* vec)
  {
  ...
  bool KrigingAlgebraSimpleCase::_isPresentMatrix(const String& name,
                                                  const AMatrix* mat)
  {
  ...
  bool KrigingAlgebraSimpleCase::_isPresentIIVector(const String& name,
                                                    const VectorVectorInt* vec)
  {
    if (vec != nullptr) return true;
