...
namespace gstlrn
{
                                          ...
                                          Id* size2Ref)
  {
    ...
    {
      messerr("First dimension of %s (%d) incorrect: it should be (%d)",
              name.c_str(),
              count,
              *size1Ref);
      return false;
    ...
    {
      messerr("Second dimension of %s (%d) incorrect: it should be (%d)",
              name.c_str(),
              size,
              *size2Ref);
      return false;
   ...
   */
  Id KrigingAlgebra::setColCokUnique(const VectorDouble* Zp,
  ...
  Id KrigingAlgebra::_patchColCokVarianceZstar(MatrixSymmetric* varZK)
  {
    ...
    AMatrix::linearCombinationInPlace(*varZK,
                                      0.,
                                      1.,
                                      *varZK,
                                      -1.,
  ...
  Id KrigingAlgebra::_needSigmac()
  {
    ...
    if (_flagBayes)
    {
      ...
      AMatrix::linearCombinationInPlace(_Sigmac,
                                        0.,
                                        1.,
                                        _Sigmac,
                                        1.,
  ...
  bool KrigingAlgebra::_isPresentIIVector(const String& name,
                                          const VectorVectorInt* vec)
  {
    if (vec != nullptr) return true;
  ...
  Id KrigingAlgebra::_needLambda0()
  {
    ...
    AMatrix::linearCombinationInPlace(bot,
                                      0.,
                                      1.,
                                      bot,
                                      -1.,
    ...
    AMatrix::linearCombinationInPlace(top,
                                      0.,
                                      1.,
                                      top,
                                      -1.,
