...
namespace gstlrn
{
  ...
  Selectivity*
    Selectivity::createByCodes(const std::vector<ESelectivity>& codes,
                                                ...
                                                bool verbose)
  {
    ...
    for (Id icut = 0; icut < ncuts; icut++)
    {
      ...
      if (iclass >= 0 && iclass < nclass)
      {
        ...
        Selectivity::_interpolateInterval(zval,
                                          zi0,
                                          zi1,
                                          ti0,
                                          ti1,
                                     ...
                                     bool verbose)
  {
    ...
    if (ntotal <= 0)
    {
      ...
      messerr("Check the recovery function (the number of cutoffs is %d)",
              getNCuts());
    }
    else
  ...
  Id Selectivity::getAddressQTEst(const ESelectivity& code,
                                  Id iptr0,
                                  Id rank) const
  {
  ...
  Id Selectivity::getAddressQTStd(const ESelectivity& code,
                                  Id iptr0,
                                  Id rank) const
  {
    if (code == ESelectivity::UNDEFINED) return -1;
  ...
  void Selectivity::dumpGini() const
  {
    ...
    for (Id iclass = 0; iclass < nclass - 1; iclass++)
      gini -= ((getTest(iclass) - getTest(iclass + 1))
