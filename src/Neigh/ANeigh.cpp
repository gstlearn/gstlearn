 ...
 * - Unique Neighborhood: all active samples are selected
 ...
 * hence the name of this Neighborhood feature
 ...
 * along the highest dimension of the space (e.g. horizontal bench for 3D space)
 ...
 * the input data base are matching grids (usually they are the same file).
 *
