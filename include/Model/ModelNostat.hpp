...
public:
  ...
  void setScale1(const VectorDouble& scales) { _setScale1(scales); }
  void setScale1(int idim, double scale) { _setScale1(idim,scale); }
  void setScale2(const VectorDouble& scales) { _setScale2(scales); }
...
private:
  ...
  void _setScale1(const VectorDouble& scales) { _scale1 = scales; }
  void _setScale1(int idim, double scale) { _scale1[idim] = scale; }
  void _setScale2(const VectorDouble& scales) { _scale2 = scales; }
