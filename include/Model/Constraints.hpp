...
namespace gstlrn
{
  ...
  {
  public:
    Constraints(double constantSillValue = TEST,
    ...
    void
      addItemFromParamId(const EConsElem& elem = EConsElem::fromKey("RANGE"),
                         Id icov = 0,
                         Id iv1 = 0,
                         Id iv2 = 0,
  ...
  private:
    ...
    VectorDouble
      _constantSills; /* Vector of constant Sills (expanded to the number of variables) */
