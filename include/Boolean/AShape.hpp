...
namespace gstlrn
{
  ...
  public:
    ...
    virtual bool belongObject(const VectorDouble& coor,
                              const BooleanObject* object) const = 0;
  ...
  private:
    ...
    std::vector<ShapeParameter>
      _params; // TODO map (regrouping the two last lines)
  };
} // namespace gstlrn
