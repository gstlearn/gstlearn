...
namespace gstlrn
{
  ...
  GSTLEARN_EXPORT VectorString
    statOptionToName(const std::vector<EStatOption>& opers);
  GSTLEARN_EXPORT std::vector<EStatOption>
    KeysToStatOptions(const VectorString& opers);
   ...
   *  @{
   */
  GSTLEARN_EXPORT VectorDouble dbStatisticsPerCell(
    Db* db,
    DbGrid* dbgrid,
  ...
  GSTLEARN_EXPORT Id statisticsProportion(
    DbGrid* dbin,
    DbGrid* dbout,
    Id pos,
    Id nfacies,
    Id radius);
  GSTLEARN_EXPORT Id statisticsTransition(
    DbGrid* dbin,
    DbGrid* dbout,
    Id pos,
    Id nfacies,
  ...
  GSTLEARN_EXPORT VectorVectorInt correlationPairs(
    Db* db1,
    Db* db2,
    const String& name1,
    const String& name2,
  ...
  GSTLEARN_EXPORT Id correlationIdentify(
    ...
    Id icol2,
    Polygons* polygon);
  GSTLEARN_EXPORT VectorVectorDouble condexp(
    Db* db1,
    Db* db2,
    Id icol1,
    Id icol2,
  ...
  GSTLEARN_EXPORT std::map<Id, std::map<Id, Id>>
  ...
  GSTLEARN_EXPORT Id dbStatisticsInGridTool(
    Db* db,
    DbGrid* dbgrid,
    const VectorString& names,
    const EStatOption& oper,
