...
namespace gstlrn
{
  ...
  public:
    ...
    virtual void getCoordinatesInPlace(VectorDouble& coor,
                                       Id iech,
    ...
    VectorString getAllNames(bool excludeRankAndCoordinates = false,
    ...
    void setLocatorsByUID(const VectorInt& iuids,
                          ...
                          bool cleanSameLocator = false);
    void
      setLocatorsByColIdx(const VectorInt& icols,
                          const ELoc& locatorType = ELoc::fromKey("UNDEFINED"),
                          Id locatorIndex = 0,
                          bool cleanSameLocator = false);
    ...
    Id addColumns(const VectorDouble& tab,
                  ...
                  Id nvar = 1);
    Id
      addColumnsByConstant(Id nadd = 1,
                           double valinit = 0.,
                           const String& radix = "New",
                           const ELoc& locatorType = ELoc::fromKey("UNDEFINED"),
                           Id locatorIndex = 0,
    ...
    void setColumnsByColIdx(const VectorDouble& tabs,
                            const VectorInt& icols,
                            bool useSel = false);
    void setColumnByColIdxOldStyle(const double* tab,
                                   Id icol,
                                   bool useSel = false);
    ...
    bool getLocatorByColIdx(Id icol,
                            ELoc* ret_locatorType,
                            Id* ret_locatorIndex) const;
    bool getLocatorByUID(Id iuid,
                         ELoc* ret_locatorType,
                         Id* ret_locatorIndex) const;
    VectorString
      getLocators(bool anyLocator = true,
    ...
    bool hasLocatorDefined(const String& name,
                           const ELoc& locatorType,
    ...
    VectorDouble getOneCoordinate(Id idim,
                                  bool useSel = false,
                                  bool flag_rotate = true) const;
    ...
    Id getDistanceVecInPlace(Id iech,
                             Id jech,
                             VectorDouble& dd,
    ...
    void updArrayVec(const VectorInt& iechs,
                     Id iuid,
    ...
    double getFromLocator(const ELoc& locatorType,
                          Id iech,
                          Id locatorIndex = 0) const;
    ...
    void updLocVariable(const ELoc& loctype,
                        Id iech,
                        Id item,
                        const EOperator& oper,
                        double value);
    ...
    void getValuesByRanksInPlace(VectorDouble* values,
                                 const VectorVectorInt& sampleRanks,
                                 const VectorDouble& means = VectorDouble(),
                                 bool subtractMean = true) const;
    static VectorInt
      getMultipleSelectedRanks(const VectorVectorInt& index,
                               const VectorInt& ivars = VectorInt(),
                               const VectorInt& nbgh = VectorInt());
    static VectorInt
    ...
    VectorDouble getColumnByUID(Id iuid,
                                bool useSel = false,
                                bool flagCompress = true) const;
    ...
    VectorVectorDouble
      getColumnsAsVVD(const VectorString& names = VectorString(),
                      bool useSel = false,
                      bool flagCompress = true) const;
    MatrixDense getColumnsAsMatrix(const VectorString& names,
                                   ...
                                   bool flagCompress = true) const;
    VectorDouble
      getColumnsByColIdx(const VectorInt& icols = VectorInt(),
                         bool useSel = false,
                         bool flagCompress = true,
                         const VectorDouble& origins = VectorDouble()) const;
    VectorDouble getColumnsByColIdxInterval(Id icol_beg,
                                            Id icol_end,
                                            bool useSel = false,
                                            bool flagCompress = true) const;
    VectorDouble getColumnsActiveAndDefined(
      ...
      const VectorDouble& origins = VectorDouble()) const;
    VectorDouble
      getColumnsByLocator(const ELoc& locatorType,
                          bool useSel = false,
                          bool flagCompress = true,
                          const VectorDouble& origins = VectorDouble()) const;
    VectorDouble
      getColumnsByUID(const VectorInt& iuids,
                      bool useSel = false,
                      bool flagCompress = true,
                      const VectorDouble& origins = VectorDouble()) const;
    VectorDouble getColumnsByUIDInterval(Id iuid_beg,
                                         Id iuid_end,
                                         bool useSel = false,
                                         bool flagCompress = true) const;
    /**@}*/
    ...
    double getCorrelation(const String& name1,
                          const String& name2,
                          bool useSel = false) const;
    /**@}*/
  ...
  protected:
    ...
    void _loadData(const VectorDouble& tab,
                   ...
                   const ELoadBy& order,
                   Id shift);
    void _loadData(const ELoadBy& order,
  ...
  private:
    ...
    bool _isCountValid(const VectorInt& iuids,
                       bool flagOne,
                       bool verbose = true) const;

  protected:
    void _defineVariableAndLocators(const Db* dbin,
                                    const VectorString& names,
                                    Id shift = 0);
    void _loadValues(const Db* db,
                     const VectorString& names,
  ...
  GSTLEARN_EXPORT bool haveSameNDim(const Db* db1,
                                    const Db* db2,
                                    const ModelGeneric* model,
                                    Id* ndim);
  GSTLEARN_EXPORT bool haveCompatibleNVar(const Db* db1,
                                          const Db* db2,
                                          const ModelGeneric* model,
                                          Id* nvar);
