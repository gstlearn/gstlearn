...
namespace gstlrn
{
  ...
  public:
    ...
    static DbGrid*
      createCoveringDb(const Db* dbin,
    ...
    static DbGrid* createMultiple(DbGrid* dbin,
                                  const VectorInt& nmult,
                                  bool flagAddSampleRank);
    static DbGrid* createDivider(DbGrid* dbin,
                                 const VectorInt& nmult,
                                 bool flagAddSampleRank);
    static DbGrid*
      createFillRandom(const VectorInt& nx,
                       Id nvar = 1,
                       Id nfex = 0,
                       Id ncode = 0,
                       double varmax = 0.,
    ...
    bool migrateAllVariables(Db* dbin,
                             bool flag_fill = true,
    ...
    void getCoordinateFromCornerInPlace(VectorDouble& coor,
    ...
    {
      return _grid.getCoordinatesByIndice(indice,
                                          flag_rotate,
                                          shift,
                                          dxsPerCell);
    }
    ...
    void getCoordinatesByIndiceInPlace(
      ...
      const VectorDouble& dxsPerCell = VectorDouble()) const
    {
      _grid.getCoordinatesByIndiceInPlace(coor,
                                          indice,
                                          flag_rotate,
                                          shift,
                                          dxsPerCell);
    ...
    void getCoordinatesPerSampleInPlace(VectorDouble& coor,
                                        Id iech,
    ...
    VectorDouble
      indicesToCoordinate(const VectorInt& indice,
                          const VectorDouble& percent = VectorDouble()) const
    {
    ...
    bool
      sampleBelongsToCell(const VectorDouble& coor,
                          Id rank,
                          const VectorDouble& dxsPerCell = VectorDouble()) const
    {
    ...
    Id setSelectionFromVariableExtend(const String& nameTop,
                                      const String& nameBot);
    ...
    VectorDouble
      getDistanceToOrigin(const VectorInt& origin,
