...
namespace gstlrn
{
  ...
  public:
    ...
    static DbLine* createFromSamples(
      Id nech,
      const ELoadBy& order,
      const VectorDouble& tab,
      const VectorInt& lineCounts,
      ...
      const VectorString& locatorNames = VectorString(),
      bool flagAddSampleRank = true);
    static DbLine* createFromSamplesById(
      Id nech,
      const ELoadBy& order,
      const VectorDouble& tab,
      const VectorInt& lineIds,
    ...
    static DbLine* createFillRandom(
      Id ndim,
      Id nbline,
      Id nperline,
      double deltaX = 5.0,
      ...
      Id seed = 13422);
    static DbLine* createVerticalFromGrid(
      const DbGrid& grid,
      const VectorString& names,
      const VectorInt& xranks,
      const VectorInt& yranks,
      Id byZ = 1);
    static DbLine* createMarkersFromGrid(
      const DbGrid& grid,
      const String& name,
      const VectorInt& xranks,
      const VectorInt& yranks,
