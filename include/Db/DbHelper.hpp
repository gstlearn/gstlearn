...
namespace gstlrn
{
  ...
  public:
    static Id findDuplicates(
      ...
      VectorDouble& sel);
    static Id centerPointToGrid(
      Db* db_point,
      DbGrid* db_grid,
      double eps_random = EPSILON6);
    static Id normalizeVariables(
      Db* db,
      const char* oper,
      const VectorInt& cols,
      double center,
      double stdv);
    static Id dbgrid_filling(
      DbGrid* dbgrid,
      Id mode = 0,
      Id seed = 34342,
      Id radius = 1,
    ...
    static Id db_duplicate(
      ...
      const NamingConvention& namconv =
        NamingConvention("Duplicate", true, true, true, ELoc::fromKey("SEL")));

    static Id db_compositional_transform(
      Db* db,
      Id verbose,
      Id mode,
      Id type,
