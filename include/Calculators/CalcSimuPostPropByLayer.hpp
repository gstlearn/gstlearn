...
namespace gstlrn
{
  ...
  public:
    ...
    CalcSimuPostPropByLayer&
      operator=(const CalcSimuPostPropByLayer& r) = delete;
  ...
  protected:
    ...
    void _transformFunction(const VectorDouble& Z_n_k_s, VectorDouble& Y_p_k_s)
      const override;
  ...
  GSTLEARN_EXPORT Id simuPostPropByLayer(
    Db* dbin,
    DbGrid* dbout,
