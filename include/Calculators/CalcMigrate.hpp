...
namespace gstlrn
{
  ...
  private:
    ...
    static Id _migratePointToGrid(
      ...
      const VectorDouble& dmax,
      VectorDouble& tab);
    static Id _expandPointToPointBall(
      Db* db1,
      Db* db2,
      Id iatt,
      Id distType,
    ...
    static Id _expandGridToGrid(
      ...
      const VectorDouble& dmax,
      VectorDouble& tab);
    static Id _interpolateGridToPoint(
      DbGrid* db_grid,
      Db* db_point,
      Id iatt,
      Id distType,
  ...
  GSTLEARN_EXPORT Id migrate(
    ...
    const NamingConvention& namconv = NamingConvention("Migrate", false));
  GSTLEARN_EXPORT Id migrateMulti(
    Db* dbin,
    Db* dbout,
  ...
  GSTLEARN_EXPORT Id migrateByAttribute(
    Db* dbin,
    Db* dbout,
    ...
    bool flag_ball = false,
    const NamingConvention& namconv = NamingConvention("Migrate"));
  GSTLEARN_EXPORT Id migrateByLocator(
    Db* dbin,
    Db* dbout,
    ...
    bool flag_ball = false,
    const NamingConvention& namconv = NamingConvention("Migrate"));
  GSTLEARN_EXPORT Id manageExternalInformation(
    Id mode,
    const ELoc& locatorType,
    Db* dbin,
    Db* dbout,
    bool* flag_created);
  GSTLEARN_EXPORT Id interpolateVariableToPoint(
    DbGrid* dbgrid,
    Id iatt,
    ...
    VectorDouble& tab);
  GSTLEARN_EXPORT VectorVectorDouble interpolateVariablesToPoint(
    DbGrid* dbgrid,
    const VectorDouble& xp,
    const VectorDouble& yp,
    const VectorDouble& zp,
    ...
    Id checkOrder = 0,
    bool flagCap = false);
  GSTLEARN_EXPORT VectorDouble interpolateOneVariableToPoint(
    DbGrid* dbgrid,
    const VectorDouble& xp,
    const VectorDouble& yp,
    const VectorDouble& zp,
    const String& name);
  GSTLEARN_EXPORT VectorDouble dbgridLineSampling(
    DbGrid* dbgrid,
    ...
    Id* nval_ret);
  GSTLEARN_EXPORT Id expandPointToGrid(
    Db* db_point,
    DbGrid* db_grid,
    Id iatt,
    Id iatt_time,
    ...
    const VectorDouble& dmax,
    VectorDouble& tab);
  GSTLEARN_EXPORT Id pointToBlock(
    Db* dbpoint,
    DbGrid* dbgrid,
    Id option,
    Id flag_size,
    ...
    Id iatt_scalev,
    Id iatt_scalew);
  GSTLEARN_EXPORT Id migrateGridToCoor(
    const DbGrid* db_grid,
    Id iatt,
    const VectorVectorDouble& coords,
    VectorDouble& tab);
  GSTLEARN_EXPORT Id expandPointToCoor(
    const Db* db1,
    Id iatt,
    const VectorVectorDouble& coords,
    VectorDouble& tab);
