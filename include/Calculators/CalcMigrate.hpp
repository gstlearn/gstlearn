...
namespace gstlrn
{
  ...
  GSTLEARN_EXPORT Id manageExternalInformation(Id mode,
                                               ...
                                               Db* dbout,
                                               bool* flag_created);
  GSTLEARN_EXPORT Id interpolateVariableToPoint(DbGrid* dbgrid,
                                                Id iatt,
  ...
  GSTLEARN_EXPORT VectorVectorDouble
    interpolateVariablesToPoint(DbGrid* dbgrid,
                                const VectorDouble& xp,
                                const VectorDouble& yp,
                                const VectorDouble& zp,
  ...
  GSTLEARN_EXPORT VectorDouble
    interpolateOneVariableToPoint(DbGrid* dbgrid,
                                  const VectorDouble& xp,
                                  const VectorDouble& yp,
                                  const VectorDouble& zp,
                                  const String& name);
