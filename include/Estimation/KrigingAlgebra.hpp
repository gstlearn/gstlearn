...
namespace gstlrn
{
  ...
  private:
    ...
    const MatrixSymmetric*
      _PriorCovs; // Bayesian Prior Covariance (Dim: _nbfl * _nbfl)
    ...
    const VectorVectorInt*
      _sampleRanks; // Vector of Vector of sampl indices per variable
