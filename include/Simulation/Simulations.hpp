...
namespace gstlrn
{
  ...
  GSTLEARN_EXPORT Id fluid_propagation(
    DbGrid* dbgrid,
  ...
  GSTLEARN_EXPORT Id tessellation_voronoi(
    DbGrid* dbgrid,
    Model* model,
  ...
  GSTLEARN_EXPORT Id tessellation_poisson(
    DbGrid* dbgrid,
    Model* model,
    const SimuPartitionParam& parparam,
    Id seed = 432432,
  ...
  GSTLEARN_EXPORT DbGrid* simulation_refine(
    DbGrid* dbin,
    Model* model,
