...
namespace gstlrn
{
  ...
  private:
    ...
    static VectorDouble
      _spectrum_exponential(Model* model, const SimuSphericalParam& sphepar);
    static VectorDouble
      _spectrum_any(Model* model, const SimuSphericalParam& sphepar);
    static void _spectrum_normalize(Id verbose, VectorDouble& freqs);
    static Id _gdiscrete(VectorDouble& freqs);
    static Id _check_degree_order(
