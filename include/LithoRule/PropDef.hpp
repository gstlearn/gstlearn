...
namespace gstlrn
{
  ...
  GSTLEARN_EXPORT Id rule_thresh_define_shadow(
    PropDef* propdef,
    Db* dbin,
    ...
    double* dsup,
    double* down);
  GSTLEARN_EXPORT Id rule_thresh_define(
    PropDef* propdef,
    Db* dbin,
    const Rule* rule,
    Id facies,
  ...
  GSTLEARN_EXPORT void
    proportion_rule_process(PropDef* propdef, const EProcessOper& mode);
  GSTLEARN_EXPORT PropDef* proportion_manage(
    Id mode,
    Id flag_facies,
    Id flag_stat,
    Id ngrf1,
