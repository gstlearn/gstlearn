...
namespace gstlrn
{
   ...
   *  @{
   */
  GSTLEARN_EXPORT void morpho_erosion(
    Id option,
    const VectorInt& radius,
    const BImage& imagin,
    BImage& imagout,
    bool verbose = false);
  GSTLEARN_EXPORT void morpho_dilation(
    Id option,
    const VectorInt& radius,
    const BImage& imagin,
    BImage& imagout,
    bool verbose = false);
  GSTLEARN_EXPORT void morpho_opening(
    Id option,
    const VectorInt& radius,
    const BImage& imagin,
    BImage& imagout,
    bool verbose = false);
  GSTLEARN_EXPORT void morpho_closing(
    Id option,
    const VectorInt& radius,
    const BImage& imagin,
    BImage& imagout,
   ...
   *  @{
   */
  GSTLEARN_EXPORT void morpho_intersection(
    const BImage& image1,
    const BImage& image2,
    BImage& imagout,
    bool verbose = false);
  GSTLEARN_EXPORT void morpho_union(
    const BImage& image1,
    const BImage& image2,
    BImage& imagout,
    bool verbose = false);
  GSTLEARN_EXPORT void morpho_negation(
    const BImage& imagin,
    BImage& imagout,
    bool verbose = false);
  /**@}*/
   ...
   *  @{
   */
  GSTLEARN_EXPORT void morpho_double2imageInPlace(
    const VectorInt& nx,
    ...
    BImage& imagout,
    bool verbose = false);
  GSTLEARN_EXPORT BImage morpho_double2image(
    const VectorInt& nx,
    const VectorDouble& tabin,
    double vmin,
    double vmax,
    bool verbose = false);
  GSTLEARN_EXPORT void morpho_image2double(
    const BImage& imagin,
    Id mode,
    double grain,
    double pore,
   ...
   *  @{
   */
  GSTLEARN_EXPORT VectorDouble morpho_labelling(
    Id option,
    Id flag_size,
    const BImage& imagin,
    double ccvoid,
    bool verbose = false);
  GSTLEARN_EXPORT VectorInt morpho_labelsize(Id option, const BImage& imagin);
  /**@}*/
   ...
   *  @{
   */
  GSTLEARN_EXPORT void morpho_distance(
    Id option,
    const VectorInt& radius,
    bool flagDistErode,
    BImage& imagin,
    VectorDouble& dist,
    bool verbose = false);
  GSTLEARN_EXPORT VectorInt gridcell_neigh(
    Id ndim,
    Id option,
    Id radius,
  ...
  GSTLEARN_EXPORT Spill_Res spillPoint(
    DbGrid* dbgrid,
  ...
  GSTLEARN_EXPORT Id db_morpho_calc(
    DbGrid* dbgrid,
    Id iptr0,
    const EMorpho& oper,
    double vmin,
  ...
  GSTLEARN_EXPORT void
    db_morpho_angle2D(DbGrid* dbgrid, const VectorInt& radius, Id iptr0);
