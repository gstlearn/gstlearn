...
namespace gstlrn
{
  ...
  GSTLEARN_EXPORT VectorDouble trendSPDE(
    Db* dbin,
    Model* model,
    Id useCholesky = -1,
    ...
    const SPDEParam& params = SPDEParam(),
    bool verbose = false);
  GSTLEARN_EXPORT Id krigingSPDE(
    Db* dbin,
    Db* dbout,
    Model* model,
    bool flag_est = true,
  ...
  GSTLEARN_EXPORT Id simulateSPDE(
    Db* dbin,
    Db* dbout,
    Model* model,
    Id nbsimu = 1,
  ...
  GSTLEARN_EXPORT double logLikelihoodSPDE(
    Db* dbin,
    Model* model,
    Id useCholesky = -1,
