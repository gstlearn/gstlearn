...
namespace gstlrn
{
  ...
  GSTLEARN_EXPORT void _token_delimitors(
    const char del_com,
    const char del_sep,
    const char del_blk);
  ...
  GSTLEARN_EXPORT void
    _buffer_write(String& buffer, const char* format, va_list ap);
  GSTLEARN_EXPORT void _lire_string(
    const char* question,
    Id flag_def,
    const char* valdef,
    char* answer);
  GSTLEARN_EXPORT Id _lire_int(
    const char* question,
    Id flag_def,
    Id valdef,
    Id valmin,
    Id valmax);
  GSTLEARN_EXPORT double _lire_double(
    const char* question,
    Id flag_def,
    double valdef,
    double valmin,
    double valmax);
  GSTLEARN_EXPORT Id
    _lire_logical(const char* question, Id flag_def, Id valdef);
