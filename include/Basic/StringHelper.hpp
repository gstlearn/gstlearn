...
namespace gstlrn
{
  ...
  GSTLEARN_EXPORT String _toStrRowHeader(const VectorString& rownames,
                                         Id iy,
                                         Id rowSize = 0);
  ...
  GSTLEARN_EXPORT String _toStrTrailer(Id ncols,
                                       Id nrows,
                                       Id ncols_util,
                                       Id nrows_util);
  ...
  GSTLEARN_EXPORT Id _askInt(const String& v,
                             Id defval = getNA<Id>(),
                             bool authTest = true);
  GSTLEARN_EXPORT double _askDouble(const String& v,
