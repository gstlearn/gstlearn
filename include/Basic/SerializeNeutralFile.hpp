...
namespace gstlrn
{
  ...
  namespace SerializeNeutralFile
  {
    ...
    bool
      tableRead(std::istream& is, const String& string, Id ntab, double* tab);
    bool tableWrite(
      std::ostream& os,
      const String& string,
      Id ntab,
  ...
  template<typename T>
  bool SerializeNeutralFile::recordWrite(
    std::ostream& os,
    const String& title,
    const T& val)
  {
  ...
  template<typename T>
  bool SerializeNeutralFile::recordWriteVec(
    std::ostream& os,
    const String& title,
    const std::vector<T>& vec)
  {
  ...
  template<typename T>
  bool SerializeNeutralFile::recordRead(
    std::istream& is,
    const String& title,
    T& val)
  {
  ...
  template<typename T>
  bool SerializeNeutralFile::recordReadVec(
    std::istream& is,
    const String& title,
    VectorT<T>& vec,
    Id nvalues)
  {
    ...
    {
      messerr(
        "Reading (%s) was expecting %d terms. %d found", title.c_str(), nvalues,
        ecr);
      vec.clear();
      return false;
    }
  ...
  template<typename T>
  bool SerializeNeutralFile::recordReadVecInPlace(
    std::istream& is,
    const String& title,
    VectorDouble::iterator& it,
    Id nvalues)
