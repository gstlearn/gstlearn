...
namespace gstlrn
{
  ...
  public:
    ...
    VectorDouble statistics(
      Db* db,
      const String& name,
      Id optionStat = 1,
      bool flagBelow = false,
      bool flagAbove = false) const;
    Id toCategoryByAttribute(Db* db, Id iatt, const NamingConvention& namconv)
      const;
    Id toIndicatorByAttribute(
      Db* db,
      Id iatt,
      Id OptionIndicator = 1,
      bool flagBelow = false,
  ...
  private:
    ...
    static Id _computeIndicator(
      ...
      bool flagAbove,
      const NamingConvention& namconv);
    static VectorDouble _computeLimitStatistics(
      Db* db,
      Id iatt,
      const VectorDouble& mini,
      const VectorDouble& maxi,
      ...
      bool flagBelow,
      bool flagAbove);
    static Id _check_bound_consistency(
      const VectorDouble& mini,
      const VectorDouble& maxi,
      const VectorBool& incmini,
      const VectorBool& incmaxi,
