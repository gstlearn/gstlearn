...
public:
  ...
  static double law_stable_unilateral_exptilt(const double alpha, const double lambda = 0.0, bool doubleRejection = true);

private:
  static double _unilateral_exptilt_singleRejection(const double alpha, const double lambda = 0.0);
  static double _unilateral_exptilt_doubleRejection(const double alpha, const double lambda = 0.0);
