...
namespace gstlrn
{
  ...
  public:
    ...
    {
      return EAnam::fromKey("HERMITIAN");
    }
    ...
    static AnamHermite*
      create(Id nbpoly = 0, bool flagBound = true, double rCoef = 1.);
