...
namespace gstlrn
{
  ...
  class GSTLEARN_EXPORT AAnam: public AStringable,
  ...
  public:
    ...
    virtual Id fitFromArray(
      const VectorDouble& tab,
      const VectorDouble& wt = VectorDouble())
    {
      DECLARE_UNUSED(tab, wt);
      return 0;
    }
