...
namespace gstlrn
{
  ...
  public:
    ...
    static DirParam* create(Id nlag = 10,
                            ...
                            const ASpaceSharedPtr& space = ASpaceSharedPtr());
    static DirParam*
      createOmniDirection(Id nlag = 10,
                          double dlag = 1.,
                          double toldis = 0.5,
                          Id opt_code = 0,
                          Id idate = 0,
                          ...
                          const ASpaceSharedPtr& space = ASpaceSharedPtr());
    static DirParam*
      createFromGrid(const DbGrid* dbgrid,
                     Id nlag = 10,
                     const VectorInt& grincr = VectorInt(),
                     const ASpaceSharedPtr& space = ASpaceSharedPtr());
    static std::vector<DirParam>
      createMultiple(Id ndir,
                     Id nlag = 10,
                     double dlag = 1.,
                     double toldis = 0.5,
                     double angref = 0.,
                     const ASpaceSharedPtr& space = ASpaceSharedPtr());
    static std::vector<DirParam>
      createSeveral2D(const VectorDouble& angles,
                      Id nlag = 10,
                      double dlag = 1.,
                      double toldis = 0.5,
                      double tolang = TEST,
  ...
  public:
    ...
    bool isLagValid(Id ilag, bool flagAsym = false) const;
