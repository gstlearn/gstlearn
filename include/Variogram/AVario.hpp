...
namespace gstlrn
{
  ...
  protected:
    ...
    double _evaluateResultVariogram(
      Id icase,
      double z11,
      double z21,
      double z12,
      double z22);
    double _evaluateResultMadogram(
      Id icase,
      double z11,
      double z21,
      double z12,
      double z22);
    double _evaluateResultRodogram(
      Id icase,
      double z11,
      double z21,
      double z12,
      double z22);
    double _evaluateResultCovariance(
      Id icase,
      double z11,
      double z21,
      double z12,
      double z22);
    double _evaluateResultOrder4(
      Id icase,
      double z11,
      double z21,
      double z12,
    ...
    const VectorDouble& _getStorage(Id ipair) const
    {
      return _tabStorage[ipair];
    }
  ...
  private:
    ...
    VectorVectorDouble
      _tabStorage; // Storage of the information on each pair; Dimension [npairs][4]
  };
