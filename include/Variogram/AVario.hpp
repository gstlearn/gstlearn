...
namespace gstlrn
{
  ...
  protected:
    ...
    double _evaluateResultVariogram(Id icase,
                                    double z11,
                                    double z21,
                                    double z12,
                                    double z22);
    double _evaluateResultMadogram(Id icase,
                                   double z11,
                                   double z21,
                                   double z12,
                                   double z22);
    double _evaluateResultRodogram(Id icase,
                                   double z11,
                                   double z21,
                                   double z12,
                                   double z22);
    double _evaluateResultCovariance(Id icase,
                                     double z11,
                                     double z21,
                                     double z12,
                                     double z22);
    double _evaluateResultOrder4(Id icase,
                                 double z11,
                                 double z21,
                                 double z12,
                                 double z22);
    ...
    double (AVario::*_evaluateResult)(Id icase,
                                      double z11,
                                      double z21,
                                      double z12,
                                      double z22);
