...
namespace gstlrn
{
  ...
  GSTLEARN_EXPORT Id multilayers_vario(
    Db* dbin,
    DbGrid* dbout,
    Vario* vario,
    bool flag_vel = false,
    ...
    const String& namereft = String(),
    bool verbose = false);
  GSTLEARN_EXPORT Id multilayers_getPrior(
    Db* dbin,
    DbGrid* dbout,
    Model* model,
    bool flag_same = false,
