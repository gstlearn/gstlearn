...
namespace gstlrn
{
  ...
  public:
     ...
     */
    template<typename T>
    static void linearCombinationInPlace(T& res,
                                         double addition,
                                         double val1,
                                         const T& other1,
                                         double val2 = 0.,
                                         ...
                                         const T& other3 = T())
    {
        ...
        [](const T& a, const T& b, const char* nameA, const char* nameB)
      {
        ...
        {
          messerr("Matrix linear combination error: matrices '%s' and '%s' "
                               ...
                               bool transpose2 = false)
    {
      ...
      Id nrow;
      Id ncol;
      if (!_areCompatible(other1.getNRows(),
                          other1.getNCols(),
                          transpose1,
                          other2.getNRows(),
                          other2.getNCols(),
                               ...
                               bool flagInit = true)
    {
      ...
      Id nrow;
      Id ncol;
      if (!_areCompatible(other.getNRows(),
                          other.getNCols(),
                          transpose,
                          vec.size(),
                          1,
    ...
    virtual void resetFromVD(Id nrows,
                             Id ncols,
  ...
  private:
    ...
    static bool _isEqualVect(const constvect& a,
                             const constvect& b,
                             double eps = EPSILON6);
