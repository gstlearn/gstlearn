...
public:
                                ...
                                const T& other3 = T())
  {
    ...
    if (addition != 0.)
      addInPlace(cumul, cumul, addition);
  ...
  {
    VectorDouble res;
    prodMVInPlace(res, other, vec, transpose, flagInit);
    return res;
  }
   ...
   */
  template<typename T>
  static void prodMVInPlace(VectorDouble& res,
                            const T& other,
                            const VectorDouble& vec,
                            bool transpose = false,
                            bool flagInit  = true)
   ...
   */
  template<typename T>
  static void prodMVInPlace(vect res,
                            const T& other,
                            const constvect vec,
                            bool transpose = false,
                            bool flagInit  = true)
  ...
  {
    VectorDouble res;
    T::prodVMInPlace(res, vec, other, transpose, flagInit);
    return res;
  }
   ...
   */
  template<typename T>
  static void prodVMInPlace(VectorDouble& res,
                            const VectorDouble& vec,
                            const T& other,
                            bool transpose = false,
                            bool flagInit  = true)
   ...
   */
  template<typename T>
  static void prodVMInPlace(vect res,
                            const constvect vec,
                            const T& other,
                            bool transpose = false,
                            bool flagInit  = true)
