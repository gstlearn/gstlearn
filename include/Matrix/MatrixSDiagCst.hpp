 ...
 */
class MatrixSDiagCst : public AMatrixSquare {

public:
  MatrixSDiagCst(int nrow = 0, bool sparse = false);
  MatrixSDiagCst(const MatrixSDiagCst &m);
  MatrixSDiagCst& operator= (const MatrixSDiagCst &r);
	virtual ~MatrixSDiagCst();
