...
namespace gstlrn
{
  ...
  public:
    ...
    Id minimizeWithConstraintsInPlace(
    ...
    Id _constraintsError(
      ...
      VectorDouble& vmat,
      VectorInt& flag);
    static Id _constraintsConcatenateMat(
      Id nae,
      Id nai,
      Id neq,
      const VectorInt& active,
      ...
      MatrixDense& tabout);
    static Id _constraintsConcatenateVD(
      Id nae,
      Id nai,
      const VectorInt& active,
