...
namespace gstlrn
{
  ...
  public:
    ...
    void resetFromArray(Id nrows,
                        Id ncols,
                        const double* tab,
                        bool byCol = true) override;
    void resetFromVD(Id nrows,
                     Id ncols,
    ...
    Id forwardLU(const VectorDouble& b,
                 VectorDouble& x,
                 bool flagLower = true) const;
