...
namespace gstlrn
{
  ...
  public:
    ...
    static MatrixSquare* createFromVD(
      const VectorDouble& X,
      Id nrow,
      bool byCol = false,
      bool invertColumnOrder = false);
    static MatrixSquare* createFromTridiagonal(
  ...
  GSTLEARN_EXPORT MatrixSquare* prodNormMatMat(
    const MatrixDense* a,
    const MatrixDense* m,
  ...
  GSTLEARN_EXPORT MatrixSquare* prodNormMatVec(
    const MatrixDense& a,
