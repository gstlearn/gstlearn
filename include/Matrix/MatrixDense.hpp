...
namespace gstlrn
{
  ...
  public:
    ...
    void addMatNoCheck(const MatrixDense& y,
                       const double cx = 1.,
                       const double cy = 1.);
  ...
  public:
    ...
    {
      return Eigen::Map<Eigen::MatrixXd, Eigen::Unaligned>(_eigenMatrix.data(),
                                                           getNRows(),
                                                           getNCols());
    }
#endif
