...
namespace gstlrn
{
  ...
  public:
    ...
    Id simulate(const FracEnviron& envir,
                bool flag_sim_layer,
                bool flag_sim_fract,
                Id seed,
                bool verbose,
    ...
    static FracList*
      fractureImport(const VectorDouble& frac_segs,
    ...
    VectorDouble fractureToWell(Id nval,
                                const VectorDouble& well,
                                double xmax,
                                const VectorDouble& permtab,
                                Id* nint,
                                Id* ncol);
    Id fractureWellToBlock(DbGrid* dbgrid,
                           Id col_perm,
                           Id col_fluid,
                           Id flag_fluid,
                           double val_fluid,
  ...
  private:
    ...
    static double _densityUpdate(const FracFault& fault,
                                 Id side,
                                 Id ifam,
                                 double cote,
                                 double xx);
    ...
    Id _simulateFractures(const FracEnviron& envir,
                          const FracFamily& family,
                          Id ifam,
                          double cote,
                          double thick,
