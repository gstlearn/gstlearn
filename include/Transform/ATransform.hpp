...
namespace gstlrn
{
  ...
  public:
    ...
    virtual void
      _printParams(std::stringstream& sstr, const AStringFormat* strfmt) const
    {
    ...
    void
      condExpVec(constvect mu, constvect sigma, vect out, Id power = 1) const;
    ...
    VectorDouble condExpVec(const VectorDouble& mu,
