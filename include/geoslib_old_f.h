...
namespace gstlrn
{
  ...
  GSTLEARN_EXPORT void
    ut_distance_allocated(Id ndim, double** tab1, double** tab2);

  /*****************************************/
  /* Prototyping the functions in morpho.c */
  /*****************************************/

  GSTLEARN_EXPORT Id spill_point(
    DbGrid* dbgrid,
    Id ind_depth,
    Id ind_data,
    Id option,
  ...
  GSTLEARN_EXPORT Id model_fitting_sills(
    Vario* vario,
    Model* model,
    const Constraints& constraints = Constraints(),
    const Option_VarioFit& optvar = Option_VarioFit(),
    const Option_AutoFit& mauto = Option_AutoFit());
  GSTLEARN_EXPORT Id model_covmat_inchol(
    Id verbose,
    Db* db,
    Model* model,
    double eta,
  ...
  GSTLEARN_EXPORT void model_cova_characteristics(
    const ECov& type,
    ...
    double* scale,
    double* parmax);
  GSTLEARN_EXPORT Model*
    model_combine(const Model* model1, const Model* model2, double r);
  ...
  GSTLEARN_EXPORT void db_sample_print(
    Db* db,
    Id iech,
    Id flag_ndim = 1,
    Id flag_nvar = 0,
  ...
  GSTLEARN_EXPORT double get_grid_value(
    DbGrid* dbgrid,
    Id iptr,
    VectorInt& indg,
    Id ix,
    Id iy,
    Id iz);
  GSTLEARN_EXPORT void set_grid_value(
    DbGrid* dbgrid,
    Id iptr,
    VectorInt& indg,
    Id ix,
  ...
  GSTLEARN_EXPORT DbGrid* db_grid_reduce(
    DbGrid* db_grid,
    Id iptr,
    const Id* margin,
    const Id* limmin,
    ...
    double vmin,
    double vmax);
  GSTLEARN_EXPORT double distance_inter(
    const Db* db1,
    const Db* db2,
    Id iech1,
    Id iech2,
  ...
  GSTLEARN_EXPORT double
    distance_intra(const Db* db, Id iech1, Id iech2, double* dist_vect);
  GSTLEARN_EXPORT double distance_grid(
    DbGrid* db,
    Id flag_moins1,
    Id iech1,
    Id iech2,
  ...
  GSTLEARN_EXPORT Id point_to_grid(
    const DbGrid* db,
    const double* coor,
    Id flag_outside,
    Id* indg);
  GSTLEARN_EXPORT Id
    point_to_bench(const DbGrid* db, double* coor, Id flag_outside, Id* indb);
  GSTLEARN_EXPORT Id index_point_to_grid(
    const Db* db,
    Id iech,
    Id flag_outside,
    const DbGrid* dbout,
  ...
  GSTLEARN_EXPORT Id db_streamline(
    DbGrid* dbgrid,
    Db* dbpoint,
    Id niter,
    double step,
    ...
    Id* npline_loc,
    VectorDouble& line);
  GSTLEARN_EXPORT void db_monostat(
    Db* db,
    Id iatt,
    double* wtot,
    double* mean,
  ...
  GSTLEARN_EXPORT Id surface(
    ...
    double* dtab,
    double* gtab);
  GSTLEARN_EXPORT Id db_grid_copy(
    DbGrid* db1,
    DbGrid* db2,
    const Id* ind1,
    const Id* ind2,
    Id ncol,
    Id* cols);
  GSTLEARN_EXPORT Id db_grid_copy_dilate(
    DbGrid* db1,
    Id iatt1,
    DbGrid* db2,
    Id iatt2,
    ...
    const Id* nshift);
  GSTLEARN_EXPORT Id
    db_proportion(Db* db, DbGrid* dbgrid, Id nfac1max, Id nfac2max, Id* nclout);
  ...
  GSTLEARN_EXPORT Id db_gradient_modang_to_component(
    Db* db,
    Id ang_conv,
    Id iad_mod,
    Id iad_ang,
    Id iad_gx,
    Id iad_gy);
  GSTLEARN_EXPORT Id db_gradient_component_to_modang(
    Db* db,
    Id verbose,
    Id iad_gx,
    Id iad_gy,
    ...
    double scale,
    double ve);
  GSTLEARN_EXPORT Db* db_point_init(
    Id nech,
  ...
  GSTLEARN_EXPORT Id db_grid2point_sampling(
    DbGrid* dbgrid,
    Id nvar,
    Id* vars,
    const Id* npacks,
    ...
    VectorDouble& coor,
    VectorDouble& data);
  GSTLEARN_EXPORT Id db_grid_patch(
    DbGrid* ss_grid,
    DbGrid* db_grid,
    Id iptr_ss,
    Id iptr_db,
  ...
  GSTLEARN_EXPORT Id stats_residuals(
    Id verbose,
    Id nech,
    double* tab,
    Id ncut,
    ...
    double* Q);
  GSTLEARN_EXPORT Id
    db_upscale(DbGrid* dbgrid1, DbGrid* dbgrid2, Id orient, Id verbose);
  GSTLEARN_EXPORT Id db_diffusion(
    DbGrid* dbgrid1,
    DbGrid* dbgrid2,
    Id orient,
    Id niter,
  ...
  GSTLEARN_EXPORT Id krige_koption_manage(
    Id mode,
    Id flag_check,
    const EKrigOpt& calcul,
    Id flag_rand,
    const VectorInt& ndiscs = VectorInt());
  GSTLEARN_EXPORT void krige_lhs_print(
    Id nech,
    Id neq,
    Id nred,
    const Id* flag,
    const double* lhs);
  GSTLEARN_EXPORT void krige_rhs_print(
    Id nvar,
    Id nech,
    Id neq,
    Id nred,
    const Id* flag,
    double* rhs);
  GSTLEARN_EXPORT Id krigsampling_f(
    Db* dbin,
    Db* dbout,
    Model* model,
    double beta,
    ...
    bool flag_std,
    Id verbose);
  GSTLEARN_EXPORT Id global_transitive(
    DbGrid* dbgrid,
    Model* model,
    Id flag_verbose,
    Id flag_regular,
  ...
  GSTLEARN_EXPORT Id sampling_f(
    ...
    VectorInt& ranks2,
    Id verbose);
  GSTLEARN_EXPORT Id inhomogeneous_kriging(
    Db* dbdat,
    Db* dbsrc,
    Db* dbout,
    double power,
  ...
  GSTLEARN_EXPORT Id simcond(
    ...
    Id flag_cstd,
    Id verbose);
  GSTLEARN_EXPORT Id simmaxstable(
    Db* dbout,
    Model* model,
    double ratio,
    Id seed,
  ...
  GSTLEARN_EXPORT Id simRI(
    ...
    Id nbtuba,
    Id verbose);
  GSTLEARN_EXPORT Id simtub_constraints(
    Db* dbin,
    Db* dbout,
    Model* model,
    ANeigh* neigh,
    ...
    Id (*func_valid)(
      ...
      double percent,
      VectorDouble& tab));
  GSTLEARN_EXPORT Id db_simulations_to_ce(
    Db* db,
    const ELoc& locatorType,
    Id nbsimu,
    Id nvar,
  ...
  GSTLEARN_EXPORT Id simfine_dim(
    DbGrid* dbin,
    Id nmult,
    Id* ndim,
    Id* ntot,
  ...
  GSTLEARN_EXPORT Id db_bounds_shadow(
    Db* db,
    Db* dbprop,
    RuleShadow* rule,
    Model* model,
  ...
  /***************************************/
  GSTLEARN_EXPORT Id m2d_gibbs_spde(
    Db* dbin,
    Db* dbout,
    Model* model,
    Id flag_ed,
...
#endif
  GSTLEARN_EXPORT AMesh* spde_mesh_load(
    Db* dbin,
    Db* dbout,
  ...
  /******************************************/
  GSTLEARN_EXPORT VectorDouble kclusters(
    ...
    Id mode,
    Id verbose);
  GSTLEARN_EXPORT VectorInt kmedoids(
    const VectorDouble& data,
    Id nvar,
    Id nech,
    Id nclusters,
