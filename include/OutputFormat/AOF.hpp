...
namespace gstlrn
{
  ...
  GSTLEARN_EXPORT Id db_grid_write_zycor(const char* filename,
                                         DbGrid* db,
                                         Id icol);
  GSTLEARN_EXPORT DbGrid*
    db_grid_read_zycor(const char* filename, Id verbose = 0);
  GSTLEARN_EXPORT Id db_grid_write_arcgis(const char* filename,
                                          DbGrid* db,
                                          Id icol);
  GSTLEARN_EXPORT Id db_grid_write_XYZ(const char* filename,
                                       DbGrid* db,
                                       Id icol);
  GSTLEARN_EXPORT Id db_write_vtk(const char* filename,
                                  DbGrid* db,
  ...
  GSTLEARN_EXPORT Id db_grid_write_irap(const char* filename,
                                        ...
                                        Id nsamplex = 1,
                                        Id nsampley = 1);
  GSTLEARN_EXPORT Id db_grid_write_ifpen(const char* filename,
                                         DbGrid* db,
                                         Id ncol,
                                         Id* icols);
  GSTLEARN_EXPORT DbGrid*
    db_grid_read_ifpen(const char* filename, Id verbose = 0);
  GSTLEARN_EXPORT Id db_grid_write_eclipse(const char* filename,
                                           DbGrid* db,
                                           Id icol);
