...
namespace gstlrn
{
  ...
  public:
    ...
    virtual void getDistancePointVectInPlace(
      const SpacePoint& p1,
    ...
    double
      getDistance(const SpacePoint& p1, const SpacePoint& p2, Id ispace = -1)
        const;
    ...
    VectorDouble
      getIncrement(const SpacePoint& p1, const SpacePoint& p2, Id ispace = -1)
        const;
    void getIncrementInPlace(
      const SpacePoint& p1,
      const SpacePoint& p2,
      VectorDouble& ptemp,
      Id ispace = -1) const;
  ...
  protected:
    ...
    /// Return the distance in frequential domain between two space points with the given tensor
    virtual double _getFrequentialDistance(
      const SpacePoint& p1,
      const SpacePoint& p2,
      const Tensor& tensor,
      Id ispace = -1) const = 0;
    ...
    virtual void _getIncrementInPlace(
      const SpacePoint& p1,
      const SpacePoint& p2,
      VectorDouble& ptemp,
      Id ispace = -1) const = 0;
