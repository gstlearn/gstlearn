...
namespace gstlrn
{
  ...
  public:
    ...
    double
      getDistance(const SpacePoint& p1, const SpacePoint& p2, Id ispace = 0)
        const;
    ...
    VectorDouble
      getIncrement(const SpacePoint& p1, const SpacePoint& p2, Id ispace = 0)
        const;
  ...
  GSTLEARN_EXPORT void defineDefaultSpace(
    const ESpaceType& type,
    size_t ndim = 2,
    double param = 0.);
