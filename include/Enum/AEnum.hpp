...
// Following includes should not be deleted ... even if they seem unused directly
...
namespace gstlrn
{
  ...
  public:
    ...
    inline std::string_view getKey() const { return _key; }
    ...
    inline std::string_view getDescr() const { return _descr; }
  ...
  {                                                                            \
    ...
    private:                                                                   \
      ...
      static const NAME* _default;                                             \
                                                                               \
    public:                                                                    \
      enum E##NAME{EXPAND(ENUM_ITEMS(NAME, __VA_ARGS__))};                     \
      E##NAME toEnum() const;                                                  \
                                                                               \
...
#define ENUM_DEFINE_(NAME, DEFAULT, ...)                                       \
  ...
  {                                                                            \
    ...
    {                                                                          \
      if (_map.find(value) != _map.end()) throw("Duplicated item");            \
      _map[value] = this;                                                      \
    }                                                                          \
                                                                               \
    NAME::~NAME() {}                                                           \
    ...
    {                                                                          \
      ...
      while (it.hasNext())                                                     \
      {                                                                        \
        if ((*it).getValue() >= from) keys.push_back(String{(*it).getKey()});  \
        it.toNext();                                                           \
      }                                                                        \
      return keys;                                                             \
    }                                                                          \
    ...
    {                                                                          \
      ...
      while (it != _map.end())                                                 \
      {                                                                        \
        if (it->second->getKey() == key) return true;                          \
        it++;                                                                  \
      }                                                                        \
      return false;                                                            \
    }                                                                          \
    ...
    {                                                                          \
      ...
      while (it != _map.end())                                                 \
      {                                                                        \
        if (it->second->getKey() == upperKey) return (*(it->second));          \
        it++;                                                                  \
      }                                                                        \
      std::cout << "Unknown key " << key << " for enum " << #NAME              \
                << std::endl;                                                  \
      return *_default;                                                        \
    }                                                                          \
                                                                               \
    ...
    {                                                                          \
      if (existsValue(value)) return (*(_map[value]));                         \
      std::cout << "Unknown value " << value << " for enum " << #NAME          \
                << std::endl;                                                  \
      return *_default;                                                        \
    }                                                                          \
                                                                               \
    ...
    {                                                                          \
      std::vector<NAME> vec;                                                   \
      for (auto v: keys) vec.push_back(fromKey(v));                            \
      return vec;                                                              \
    }                                                                          \
                                                                               \
    ...
    {                                                                          \
      std::vector<NAME> vec;                                                   \
      for (auto v: values) vec.push_back(fromValue(v));                        \
      return vec;                                                              \
    }                                                                          \
                                                                               \
