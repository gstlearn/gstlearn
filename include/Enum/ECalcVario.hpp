...
#define ENUM_CALC_VARIO                                                        \
  ECalcVario, VARIOGRAM, VARIOGRAM, 0, "Variogram", COVARIANCE, 1,             \
    "Covariance", COVARIOGRAM, 2, "Transitive Covariogram", MADOGRAM, 3,       \
    "Madogram", RODOGRAM, 4, "Rodogram", POISSON, 5, "Poisson Variogram",      \
    GENERAL1, 6, "Generalized Variogram of order 1", GENERAL2, 7,              \
    "Generalized Variogram of order 2", GENERAL3, 8,                           \
    "Generalized Variogram of order 3", COVARIANCE_NC, 9,                      \
    "Non-centered Covariance", ORDER4, 10, "Order-4 Variogram", TRANS1, 11,    \
    "Cross-to-Simple Variogram ratio G12/G1", TRANS2, 12,                      \
    "Cross-to-Simple Variogram ratio G12/G2", BINORMAL, 13,                    \
    "Cross-to-Simple Variogram ratio G12/sqrt(G1*G2)", CORRELOGRAM, 14,        \
    "Correlation Variogram"
...
struct qualifier
{
  ...
  bool
    isCentered; // True if this tool is centered by Mean (e.g. Covariance), false otherwise (e.g. Variogram)
  bool
    isScaled; // True if this tool is scaled by St. Dev. (e.g. Correlation), false otherwise (e.g. Variogram)
