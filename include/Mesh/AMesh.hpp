...
namespace gstlrn
{
  ...
  public:
    ...
    /*! Returns coordinate 'idim' of apex 'rank' of mesh 'imesh' */
    virtual void
      getCoordinatesPerMeshInPlace(Id imesh, Id rank, VectorDouble& coords)
        const;
    ...
    virtual Id getMeshAndInPlaceWeightsFromCoordinates(
    ...
    void getEmbeddedCoordinatesPerMeshInPlace(Id imesh, VectorVectorDouble& vec)
      const;
