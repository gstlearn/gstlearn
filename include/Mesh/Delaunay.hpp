...
namespace gstlrn
{
  ...
  GSTLEARN_EXPORT VectorDouble
    extend_grid(DbGrid* db, const VectorDouble& gext, Id* nout);
  GSTLEARN_EXPORT VectorDouble
    extend_point(Db* db, const VectorDouble& gext, Id* nout);
  GSTLEARN_EXPORT Id MSS(Id ndim, Id ipol, Id icas, Id icorn, Id idim);
  GSTLEARN_EXPORT Id meshes_2D_write(
  ...
  GSTLEARN_EXPORT void mesh_stats(
    Id ndim,
    Id ncorner,
    Id nmesh,
    const I32* meshes,
