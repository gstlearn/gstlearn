...
namespace gstlrn
{
  ...
  public:
    ...
    void
      prodTildeC(const VectorDouble& x, VectorDouble& y, const EPowerPT& power)
        const;

    void prodLambdaOnSqrtTildeC(
  ...
  private:
    ...
    static void _mapTildeCUpdate(
      std::map<Id, double>& tab,
      Id ip0,
      double value,
      double tol = EPSILON10);

    static void _mapGradUpdate(
