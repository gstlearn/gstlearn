...
{
public:
  ParamId(const EConsElem& elem = EConsElem::fromKey("UNDEFINED"), Id iv1 = 0, Id iv2 = 0);
  ...
  static ParamId* create(const EConsElem& elem = EConsElem::fromKey("UNDEFINED"),
                         Id iv1                = 0,
                         Id iv2                = 0);
