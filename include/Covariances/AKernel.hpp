...
namespace gstlrn
{
  ...
  public:
    ...
    {
      return String("Equation is not provided");
    }
    ...
    virtual double
      simulateTurningBand(double t0, TurningBandOperate& operTB) const
    {
      DECLARE_UNUSED(t0);
    ...
    double
      evaluateCovOnSphere(double alpha, double scale, Id degree = 50) const;
    VectorDouble
      evaluateSpectrumOnSphere(Id n, double scale, bool flagScale = true) const;
  ...
  protected:
    ...
    virtual double
      _evaluateCovOnSphere(double alpha, double scale = 1., Id degree = 50)
        const;
