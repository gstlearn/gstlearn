...
namespace gstlrn
{
  ...
  public:
    ...
    CorAniso(const CovContext& ctxt,
             const ECov& type,
             double param,
             double range,
             bool flagRange = true);
    ...
    static CorAniso* createIsotropic(const CovContext& ctxt,
                                     ...
                                     bool flagRange = true);
    static CorAniso*
      createAnisotropic(const CovContext& ctxt,
                        const ECov& type,
                        const VectorDouble& ranges,
                        double param = 1.,
                        const VectorDouble& angles = VectorDouble(),
    ...
    static CorAniso* createIsotropicMulti(const CovContext& ctxt,
                                          ...
                                          bool flagRange = true);
    static CorAniso*
      createAnisotropicMulti(const CovContext& ctxt,
                             const ECov& type,
                             const VectorDouble& ranges,
                             double param = 1.,
                             const VectorDouble& angles = VectorDouble(),
    ...
    void addEvalCorFromHVect(constvect h,
                             vect res,
    ...
    Id makeElemNoStatOnMesh(const EConsElem& econs,
                            Id iv1,
                            Id iv2,
                            const Db* db = nullptr,
    ...
    void makeRangeNoStatDb(const String& namecol,
                           Id idim = 0,
                           const Db* db = nullptr);
    void makeScaleNoStatDb(const String& namecol,
                           Id idim = 0,
                           const Db* db = nullptr);
    void makeAngleNoStatDb(const String& namecol,
                           Id idim = 0,
                           const Db* db = nullptr);
    void makeTensorNoStatDb(const String& namecol,
                            Id idim = 0,
                            Id jdim = 0,
                            const Db* db = nullptr);
    ...
    void makeTensorNoStatFunctional(const AFunctional* func,
                                    Id idim = 0,
                                    Id jdim = 0);
    ...
    Array evalCovFFT(const VectorDouble& hmax,
                     Id N = 128,
                     Id ivar = 0,
                     Id jvar = 0) const;
    ...
    void setMarkovCoeffsBySquaredPolynomials(VectorDouble coeffs1,
    ...
    void optimizationTransformSPNew(const SpacePoint& ptin,
