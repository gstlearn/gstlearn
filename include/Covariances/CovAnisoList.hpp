...
namespace gstlrn
{
  ...
  public:
    ...
    void makeTensorNoStatDb(Id icov,
                            const String& namecol,
                            Id idim = 0,
                            Id jdim = 0);
    void makeParamNoStatDb(Id icov, const String& namecol);
    void
      makeRangeNoStatFunctional(Id icov, const AFunctional* func, Id idim = 0);
    void
      makeScaleNoStatFunctional(Id icov, const AFunctional* func, Id idim = 0);
    void
      makeAngleNoStatFunctional(Id icov, const AFunctional* func, Id idim = 0);
    void makeTensorNoStatFunctional(Id icov,
