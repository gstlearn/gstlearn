...
namespace gstlrn
{
  ...
  {
  public:
    CorGaussianMixture(const CovContext& ctxt,
                       const ECov& type,
    ...
    static CorGaussianMixture*
      create(const CovContext& ctxt,
             const ECov& type,
  ...
  private:
    ...
    double
      _scaleGneiting; // additional coefficient used for the implementation of the Gneiting model
  };
} // namespace gstlrn
