...
namespace gstlrn
{
  typedef std::function<double(const SpacePoint&,
                               const SpacePoint&,
                               Id,
                               Id,
  ...
  public:
    ...
    virtual SpectrumRN
      simulateSpectrumRN(Id ns, const ACov* cov0 = nullptr) const;
    virtual double
      evalSpectrum(const VectorDouble& freq, Id ivar = 0, Id jvar = 0) const;
    virtual double evalSpectrumRatio(const VectorDouble& freq,
                                     Id ivar,
                                     Id jvar,
                                     const ACov* cov0 = nullptr) const;
    virtual VectorDouble
      evalSpectrumOnSphere(Id n,
...
#endif
    /////////////////////////////////////////////////////////////////////////////////
    void eval0CovMatBiPointInPlace(MatrixSymmetric& mat,
    ...
    void makeStationary();
    virtual Id makeElemNoStat(const EConsElem& econs,
                              Id iv1,
                              Id iv2,
  ...
  private:
    ...
    Id _makeElemNoStat(const EConsElem& econs,
                       Id iv1,
                       Id iv2,
                       const AFunctional* func = nullptr,
                       const Db* db = nullptr,
