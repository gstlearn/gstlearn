...
namespace gstlrn
{
  ...
  public:
    ...
    SpacePoint&
      _optimizationLoadInPlace(Id iech, Id mode, Id rank) const override;
    ...
    void
      setActiveCovList(const VectorInt& activeCovList, bool allActiveCov) const;
  ...
  protected:
    std::vector<std::shared_ptr<CovBase>>
      _covs; /// Vector of elementary covariances
    ...
    mutable VectorInt
      _allActiveCovList; /*! List of indices of all covariances */
    mutable VectorInt
      _activeCovList; /*! List of indices of the active covariances */
#endif

  private:
    mutable AModelFitSills*
      _modelFitSills; /* Model fitting procedure for Sills */
