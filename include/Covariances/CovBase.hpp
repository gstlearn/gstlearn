...
namespace gstlrn
{
  ...
  public:
    ...
    void makeSillNoStatDb(const String& namecol,
                          Id ivar = 0,
                          Id jvar = 0,
                          const Db* db = nullptr);
    void makeSillStationary(Id ivar = 0, Id jvar = 0);
    void makeSillsStationary(bool silent = false);
    void makeSillNoStatFunctional(const AFunctional* func,
                                  Id ivar = 0,
                                  Id jvar = 0);
  ...
  private:
    ...
    void _multiplyCorDerivativesBySills(Id oldSize,
