...
namespace gstlrn
{
  ...
  public:
    ...
    virtual void setSill(double sill)
      const; /// Only valid when there is only one variable (in the context)
    ...
    {
      return static_cast<TabNoStatSills&>(*_tabNoStat);
    }
    ...
    {
      return _cholSillsInfo(ivar, jvar);
    }
  ...
  private:
    ...
    void _multiplyCorDerivativesBySills(
      Id oldSize,
