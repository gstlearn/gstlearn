  ...
  int* ier)
{
  ...
  /*   from node K. */
  trfind_(
    &ist, p, &km1, &x[1], &y[1], &z__[1], &list[1], &lptr[1], &lend[1], &b1,
    &b2, &b3, &i1, &i2, &i3);
  ...
  int* ier)
{
  ...
  if (!left_(
        &x[1], &y[1], &z__[1], &x[2], &y[2], &z__[2], &x[3], &y[3], &z__[3]))
  {
    ...
    lend[3] = 6;
             ...
             &x[2], &y[2], &z__[2], &x[1], &y[1], &z__[1], &x[3], &y[3],
             &z__[3]))
  {
  ...
  *lnew = 7;
  ...
  {
    addnod_(
      &near__[k], &k, &x[1], &y[1], &z__[1], &list[1], &lptr[1], &lend[1], lnew,
      ier);
    if (*ier != 0)
    {
      return 0;
