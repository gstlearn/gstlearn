...
int main(int argc, char* argv[])
{
  ...
  print_vector("Variogram for: ivar=0, jvar=0 (no compress)", vec00, true, true);

  VectorDouble vec10 = vario->getGgVec(0, 1, 0, false, false, compress);
  print_vector("Variogram for: ivar=1, jvar=0 (no compress)", vec10, true, true);

  VectorDouble vec11 = vario->getGgVec(0, 1, 1, false, false, compress);
  print_vector("Variogram for: ivar=1, jvar=1 (no compress)", vec11, true, true);
  ...
  print_vector("Variogram for: ivar=0, jvar=0", vec00, true, true);

  vec10 = vario->getGgVec(0, 1, 0, false, false, compress);
  print_vector("Variogram for: ivar=1, jvar=0", vec10, true, true);

  vec11 = vario->getGgVec(0, 1, 1, false, false, compress);
  print_vector("Variogram for: ivar=1, jvar=1", vec11, true, true);
