...
int main(int argc, char* argv[])
{
  ...
  (void)ConditionalExpectation(blocs,
                               anam,
                               selectivity,
                               "G_PTS*estim",
                               "G_PTS*stdev",
  ...
  (void)UniformConditioning(blocs,
                            anam,
                            selectivity,
                            "Z_PTS*estim",
                            "Z_PTS*stdev",
  ...
  Vario* vario_b1_Z = Vario::createRegularizeFromModel(*model,
                                                       *varioparam,
                                                       blocs->getDXs(),
                                                       ndisc_B,
                                                       blocs->getAngles());
  ...
  (void)model_b1_Y->fit(vario_b1_Y,
                        {ECov::CUBIC, ECov::EXPONENTIAL},
                        constraints);
  ...
  // Regularization of the point model by the block support
  Vario* vario_b2_Y = Vario::createRegularizeFromModel(*model,
                                                       *varioparam,
                                                       blocs->getDXs(),
                                                       ndisc_B,
                                                       blocs->getAngles());
  ...
  (void)model_b2_Y->fit(vario_b2_Y,
                        {ECov::CUBIC, ECov::EXPONENTIAL},
                        constraints);
