...
int main(int argc, char* argv[])
{
  ...
  if (mode == 0 || mode == 1)
  {
    ...
    Db* dbiso = Db::createFromSamples(4,
                                      ELoadBy::SAMPLE,
                                      tabiso,
                                      {"x", "iso"},
                                      {"x1", "layer"});
    ...
    Db* dbgrd = Db::createFromSamples(1,
                                      ELoadBy::SAMPLE,
                                      tabgrd,
                                      {"x", "gx"},
                                      {"x1", "g1"});
  ...
  if (mode == 0 || mode == 2)
  {
    ...
    Db* dbiso = Db::createFromSamples(10,
                                      ELoadBy::SAMPLE,
                                      tabiso,
                                      {"x", "y", "iso"},
                                      {"x1", "x2", "layer"});
    ...
    Db* dbgrd = Db::createFromSamples(3,
                                      ELoadBy::SAMPLE,
                                      tabgrd,
                                      {"x", "y", "gx", "gy"},
                                      {"x1", "x2", "g1", "g2"});
    ...
    Db* dbtgt = Db::createFromSamples(2,
                                      ELoadBy::SAMPLE,
                                      tabtgt,
                                      {"x", "y", "tx", "ty"},
