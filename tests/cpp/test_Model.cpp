...
int main(int argc, char* argv[])
{
  ...
  modelS->addCovFromParam(ECov::SPHERICAL,
                          TEST,
                          23.,
                          TEST,
                          {2., 3., 4.},
  ...
  //                                           nullptr, true);
  Model* modelSph = Model::createFromParam(ECov::MATERN,
                                           1. / kappa,
                                           1.,
                                           mu,
                                           VectorDouble(),
                                           ...
                                           nullptr,
                                           false);
  printVector(modelSph->getCovAniso(0)->evalSpectrumOnSphere(ns),
              "Spectrum",
              true,
              true);
  printVector(modelSph->getCovAniso(0)->evalCovOnSphereVec(incr, 50, false),
              "Covariance",
              true,
              true);
