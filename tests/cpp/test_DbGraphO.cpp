...
int main(int argc, char* argv[])
{
  ...
  printVector(iadenddown,
              "List of Node indices end-of-stream downwards",
              true,
              true);

  // Check the end-of-stream points upwards
  VectorInt iadendup = dbgraphO->getEndsUp();
  printVector(iadendup,
              "List of Node indices end-of-stream upwards",
              true,
              true);
  // Check the orphans
