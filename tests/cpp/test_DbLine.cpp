...
int main(int argc, char* argv[])
{
  ...
  VectorDouble z1 = {1.2, 2.5, 3.6, 1.4, 0.3, 0.2,
                     8.2, 0.3, 3.2, 1.2, 0.4, 0.1};
  VectorDouble z2 = {3.1, 2.7, 3.2, 8.1, 5.3, 7.2,
                     9.2, 1.1, 0.3, 0.6, 1.5, 5.2};
  VectorDouble tab;
  ...
  DbLine* dbline = DbLine::createFromSamples(
    static_cast<Id>(x1.size()), ELoadBy::COLUMN, tab, lineCounts,
