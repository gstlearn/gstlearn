...
static void _firstTest(Db* data, Db* target, ModelGeneric* model, ANeigh* neigh)
{
  ...
  printVector(
    Kcalc.getStdv(), "Standard Deviation of Estimation Error", true, true);
...
static void _secondTest(Db* data, Db* target, ModelGeneric* model)
{
  ...
  printVector(
    KcalcP.getStdv(), "Standard Deviation of Estimation Error", true, true);
...
static void _fourthTest(Db* data, Db* target, ModelGeneric* model)
{
  ...
  printVector(
    Kcalc1.getStdv(), "Standard Deviation of Estimation Error", true, true);
