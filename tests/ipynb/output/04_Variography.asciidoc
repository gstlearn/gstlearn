...
----
  ...
  31 -  CAUCHY_GEN : Generalized Cauchy in 1-D
  32 -  GNEITING_G : Gneiting with Gaussian spatial trace
  33 -  GNEITING_M : Gneiting with Matern's spatial trace
  34 -  GNEITING_C : Gneiting with Cauchy's spatial trace
----
...
Cubic
- Sill         =      0.951
- Ranges       =    155.284   213.126
- Angles       =    155.282     0.000
- Rotation Matrix
               [,  0]    [,  1]
     [  0,]     0.908     0.418
     [  1,]    -0.418     0.908
