...
gl.argumentTestVectorVectorDouble([[2.0, 3.0], [1.0, 5]])
...
gl.argumentTestDoubleOverload(2.0)
gl.argumentTestDoubleOverload((2.0, 3.0))
...
print("nan") if (gl.isNaN(gl.argumentReturnInt(np.nan))) else print(
    "oups"
)  # No NaN value for integers so use isNaN
print(gl.argumentReturnDouble(21.4))
print(gl.argumentReturnDouble(np.nan))
print(gl.argumentReturnVectorDouble([1.0, 2.0, 3.0]))
