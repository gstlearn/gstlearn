...
covtape = gl.CovLMCTapering(gl.ETape.STORKEY, 2., ctxt.getSpaceSh())
...
covconv = gl.CovLMCConvolution(gl.EConvType.EXPONENTIAL, gl.EConvDir.X, 0.1, 10, ctxt.getSpaceSh())
cova = gl.CovAniso(gl.ECov.EXPONENTIAL, 2, 0, 1.5, ctxt)
covconv.addCov(cova)
