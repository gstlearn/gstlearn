...
V1 = MSP.getDiagonal()
gl.printVector("Main Diagonal",Vref, False, True)
print("Are results for MRR and MSP similar: ",gl.VH.isEqual(Vref,V1))
Vref = MRR.getDiagonal(1)
V1 = MSP.getDiagonal(1)
gl.printVector("Second Diagonal Below",Vref, False, True)
print("Are results for MRR and MSP similar: ",gl.VH.isEqual(Vref,V1))
Vref = MRR.getDiagonal(-2)
V1 = MSP.getDiagonal(-2)
gl.printVector("Third Diagonal Above",Vref, False, True)
print("Are results for MRR and MSP similar: ",gl.VH.isEqual(Vref,V1))
Vref = MRR.getRow(2)
V1 = MSP.getRow(2)
gl.printVector("Third Row",Vref, False, True)
print("Are results for MRR and MSP similar: ",gl.VH.isEqual(Vref,V1))
Vref = MRR.getColumn(3)
V1 = MSP.getColumn(3)
gl.printVector("Fourth Column",Vref, False, True)
print("Are results for MRR and MSP similar: ",gl.VH.isEqual(Vref,V1))
