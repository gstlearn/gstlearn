...
print(
    "Are results for MRR and MSG similar: ",
    gl.VH.isEqual(np.array(Vref.getVector()), np.array(V2.getVector())),
)
MSS.prodMatVecInPlace(V1, V2)
print(
    "Are results for MRR and MSS similar: ",
    gl.VH.isEqual(np.array(Vref.getVector()), np.array(V2.getVector())),
)
MSP.prodMatVecInPlace(V1, V2)
print(
    "Are results for MRR and MSP similar: ",
    gl.VH.isEqual(np.array(Vref.getVector()), np.array(V2.getVector())),
)
