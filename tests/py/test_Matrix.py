...
V1 = MSP.getDiagonal()
gl.print_vector("Main Diagonal",Vref, False, True)
print("Are results for MRR and MSP similar: ",gl.VH.isEqual(Vref,V1))
Vref = MRR.getDiagonal(1)
V1 = MSP.getDiagonal(1)
gl.print_vector("Second Diagonal Below",Vref, False, True)
print("Are results for MRR and MSP similar: ",gl.VH.isEqual(Vref,V1))
Vref = MRR.getDiagonal(-2)
V1 = MSP.getDiagonal(-2)
gl.print_vector("Third Diagonal Above",Vref, False, True)
print("Are results for MRR and MSP similar: ",gl.VH.isEqual(Vref,V1))
Vref = MRR.getRow(2)
V1 = MSP.getRow(2)
gl.print_vector("Third Row",Vref, False, True)
print("Are results for MRR and MSP similar: ",gl.VH.isEqual(Vref,V1))
Vref = MRR.getColumn(3)
V1 = MSP.getColumn(3)
gl.print_vector("Fourth Column",Vref, False, True)
print("Are results for MRR and MSP similar: ",gl.VH.isEqual(Vref,V1))
...
print("Are results for MRR and MSG similar: ",gl.VH.isEqual(np.array(Vref.getVector()),np.array(V2.getVector())))
MSS.prodMatVecInPlace(V1, V2)
print("Are results for MRR and MSS similar: ",gl.VH.isEqual(np.array(Vref.getVector()),np.array(V2.getVector())))
MSP.prodMatVecInPlace(V1, V2)
print("Are results for MRR and MSP similar: ",gl.VH.isEqual(np.array(Vref.getVector()),np.array(V2.getVector())))
...
print("Are results correct for MSS: ",gl.VH.isEqual(V1,np.array(V3.getVector())))
MSP.solve(V1, V2)
MSP.prodMatVecInPlace(np.array(V2.getVector()), V3)
print("Are results correct for MSP: ",gl.VH.isEqual(V1,np.array(V3.getVector())))
