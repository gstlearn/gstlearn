...
V1 = MSP.getDiagonal()
gl.printVector(Vref, "Main Diagonal", False, True)
print("Are results for MRR and MSP similar: ",gl.VH.isEqual(Vref,V1))
Vref = MRR.getDiagonal(1)
V1 = MSP.getDiagonal(1)
gl.printVector(Vref, "Second Diagonal Below", False, True)
print("Are results for MRR and MSP similar: ",gl.VH.isEqual(Vref,V1))
Vref = MRR.getDiagonal(-2)
V1 = MSP.getDiagonal(-2)
gl.printVector(Vref, "Third Diagonal Above", False, True)
print("Are results for MRR and MSP similar: ",gl.VH.isEqual(Vref,V1))
Vref = MRR.getRow(2)
V1 = MSP.getRow(2)
gl.printVector(Vref, "Third Row", False, True)
print("Are results for MRR and MSP similar: ",gl.VH.isEqual(Vref,V1))
Vref = MRR.getColumn(3)
V1 = MSP.getColumn(3)
gl.printVector(Vref, "Fourth Column", False, True)
print("Are results for MRR and MSP similar: ",gl.VH.isEqual(Vref,V1))
