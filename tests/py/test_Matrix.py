...
V1 = MSP.getDiagonal()
gl.print_vector("Main Diagonal",Vref)
print("Are results for MRR and MSP similar: ",gl.VH.isEqual(Vref,V1))
Vref = MRR.getDiagonal(1)
V1 = MSP.getDiagonal(1)
gl.print_vector("Second Diagonal Below",Vref)
print("Are results for MRR and MSP similar: ",gl.VH.isEqual(Vref,V1))
Vref = MRR.getDiagonal(-2)
V1 = MSP.getDiagonal(-2)
gl.print_vector("Third Diagonal Above",Vref)
print("Are results for MRR and MSP similar: ",gl.VH.isEqual(Vref,V1))
Vref = MRR.getRow(2)
V1 = MSP.getRow(2)
gl.print_vector("Third Row",Vref)
print("Are results for MRR and MSP similar: ",gl.VH.isEqual(Vref,V1))
Vref = MRR.getColumn(3)
V1 = MSP.getColumn(3)
gl.print_vector("Fourth Column",Vref)
print("Are results for MRR and MSP similar: ",gl.VH.isEqual(Vref,V1))
