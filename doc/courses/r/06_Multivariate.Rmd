...
ggDefault(2) + plot(dat, name_color="Elevation")
```

## Map of the elevations on Grid

```{r maps-elevation-2, echo=FALSE}
ggDefault(2) + plot(target, name_raster="Elevation")
```
...
p = p + plot(dat, name_size="Temperature", reduction = 200)
...
```{r}
p = ggplot()
p = p + plot.varmod(varioexp2var, fitmod2var)
p = p + plot.decoration(title="Temperature (°C) and Elevation")
ggPrint(p)
```
