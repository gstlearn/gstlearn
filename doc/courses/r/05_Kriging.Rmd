...
p = ggplot()
p = p + plot.correlation(grid,name1="OK.January_temp.estim",name2="SK.January_temp.estim", 
...
p = ggplot()
p = p + plot.correlation(grid,name1="OK.January_temp.stdev",name2="SK.January_temp.stdev", 
                     flagRegr=TRUE, flagSameAxes=TRUE, bins=100)
