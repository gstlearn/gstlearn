...
ax = plot.grid(grid,name="OK*estim",title="Estimation by Ordinary Kriging",end.plot=FALSE)
...
ax = plot.grid(grid,name="OK*stdev",title="St. dev. by Ordinary Kriging",end.plot=FALSE)
plot.point(dat,size_name="January_temp",padd=ax,sizmax=300,color0='black')
```
...
ax = plot.grid(grid,name="SK*estim",title="Estimation by Simple Kriging",end.plot=FALSE)
plot.point(dat,size_name="January_temp",padd=ax,sizmax=300,color0='black')
```
...
ax = plot.grid(grid,name="SK*stdev",title="St. dev. by Simple Kriging",end.plot=FALSE)
plot.point(dat,size_name="January_temp",padd=ax,sizmax=300,color0='black')
```
...
```{r}
small.neigh = NeighMoving_create(flag_xvalid=FALSE,
...
moving.neigh = NeighMoving_create(flag_xvalid=FALSE,
