...
plot.grid(grid, title="Ordinary Kriging over whole Grid", legend.name="°C",asp=1,zlim= c(0.,8.))
```
...
ax = plot.grid(grid,name="OK*estim",title="Estimation by Ordinary Kriging",asp=1,
               legend.name="°C", zlim=c(0.,8.), end.plot=FALSE)
plot.point(dat,size_name="January_temp",padd=ax,sizmax=300,color0='black')
```
...
ax = plot.grid(grid,name="OK*stdev",title="St. dev. by Ordinary Kriging",asp=1,
               legend.name="°C", zlim=c(0.,1.), end.plot=FALSE)
plot.point(dat,size_name="January_temp",padd=ax,sizmax=300,color0='black')
```
...
ax = plot.grid(grid,name="SK*estim",title="Estimation by Simple Kriging",asp=1,
               legend.name="°C", zlim=c(0.,8.), end.plot=FALSE)
plot.point(dat,size_name="January_temp",padd=ax,sizmax=300,color0='black')
```
...
ax = plot.grid(grid,name="SK*stdev",title="St. dev. by Simple Kriging",asp=1,
               legend.name="°C", zlim=c(0.,1.), end.plot=FALSE)
plot.point(dat,size_name="January_temp",padd=ax,sizmax=300,color0='black')
```
...
ax = plot.grid(grid,name="inshore",show.legend=FALSE, asp=1,end.plot=FALSE)
...
```{r}
small.neigh = NeighMoving_create(flag_xvalid=FALSE,nmini=1, nmaxi=1, radius=1000000)
```
...
ax = plot.grid(grid,name="Small*estim",
               title="Estimation by Ordinary Kriging (Small Neigh.)", zlim=c(0.,8.), asp=1,
               legend.name="°C", end.plot=FALSE)
...
moving.neigh = NeighMoving_create(flag_xvalid=FALSE,nmini=1, nmaxi=10, radius=20)
```
...
ax = plot.grid(grid,name="Reduced*estim",
               title="Estimation by Ordinary Kriging (Reduced Moving Neigh.)", zlim=c(0.,8.), asp=1,
               legend.name="°C", end.plot=FALSE)
plot.point(dat,size_name="January_temp",padd=ax)
```
...
moving.neigh = NeighMoving_create(flag_xvalid=FALSE,nmini=1, nmaxi=10, radius=150)
```
...
ax = plot.grid(grid,name="Moving*estim",
               title="Estimation by Ordinary Kriging (Moving Neigh.)", zlim=c(0.,8.), asp=1,
               legend.name="°C", end.plot=FALSE)
plot.point(dat,size_name="January_temp",padd=ax)
```
...
ax = plot.grid(grid,name="Moving*stdev",
               title="St. dev. by Ordinary Kriging (Moving Neigh.)", zlim=c(0.,1.), asp=1,
               legend.name="°C", end.plot=FALSE,)
plot.point(dat,size_name="January_temp",padd=ax)
```
...
plot.correlation(grid,name1 = "OK*estim",name2="Moving*estim", flagDiag=TRUE, 
                 title="Ordinary Kriging Estimation", 
