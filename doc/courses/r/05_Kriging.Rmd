...
p = plot.point(dat,name_size="January_temp",padd=p,sizmax=3,color='black')
...
p = plot.correlation(grid,name1="OK*estim",name2="SK*estim", 
...
p = plot.correlation(grid,name1 = "OK*stdev",name2="SK*stdev", 
                     flagRegr=TRUE, flagSameAxes=TRUE, bins=100)
...
p = plot.hist(dat,name="*esterr*",bins=30,fill="blue")
...
```{r}
p = plot.hist(dat,name="*stderr*",bins=30,fill="blue")
