...
plot.correlation(grid,"Cr","P", bins=100)
```
...
plot.correlation(grid,"Ni","P", bins=100)
```
...
plot.correlation(grid,"Ni","Cr", bins=100)
```
...
p = plot.correlation(grid,"Fill.P","Mono.Fill.P", bins=100)
...
p = plot.correlation(grid,"Fill.P","Multi.Fill.P", bins=100)
...
```{r}
p = plot.correlation(grid, "Mono.Fill.P", "Multi.Fill.P", bins=100)
