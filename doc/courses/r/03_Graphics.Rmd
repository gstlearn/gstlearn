...
```{r}
p = plot.init(asp=1)
p = p + plot.symbol(mygrid, nameSize="Simu.S1", nameColor="Simu.S2", flagLegend = TRUE,
...
```{r}
p = plot.init(asp=1)
p = p + plot.raster(mygrid, name="Simu.S1")
...
p1 = plot.init(asp=1) + plot.raster(mygrid, name="Simu.S1",
                                    flagLegend=TRUE, legendName="Colors #1")
p1 = p1 + plot.decoration(title="Simulation 1", xlab="Easting", ylab="Northing")
p2 = plot.init(asp=1) + plot.raster(mygrid, name="Simu.S2", flagLegend=FALSE)
