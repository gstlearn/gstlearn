...
p1 = plot.init(dims=c(6,6)) +
  plot(grid, name=NamingConvention_getNameEncoded("SimuPGS", NULL, 1, 1, 1, nbsimu), palette=cmap) +
  plot(data, nameColor="facies", nameSize="connect", palette=cmap)
p2 = plot.init(dims=c(6,6)) +
  plot(grid, name=NamingConvention_getNameEncoded("SimuPGS", NULL, 1, 1, 2, nbsimu), palette=cmap) +
  plot(data, nameColor="facies", nameSize="connect", palette=cmap)
p3 = plot.init(dims=c(6,6)) +
  plot(grid, name=NamingConvention_getNameEncoded("SimuPGS", NULL, 1, 1, 3, nbsimu), palette=cmap,) +
  plot(data, nameColor="facies", nameSize="connect", palette=cmap)
p4 = plot.init(dims=c(6,6)) +
  plot(grid, name=NamingConvention_getNameEncoded("SimuPGS", NULL, 1, 1, 4, nbsimu), palette=cmap) +
  plot(data, nameColor="facies", nameSize="connect", palette=cmap)
...
isValid = accept(data, grid, NamingConvention_getNameEncoded("SimuPGS", NULL, 1, 1, 1, nbsimu), TRUE)
...
for (i in 1:nbsimu)
{
  name = NamingConvention_getNameEncoded("SimuPGS", NULL, 1, 1, i, nbsimu)
  cat("Simulation",name)
