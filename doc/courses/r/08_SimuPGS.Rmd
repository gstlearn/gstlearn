...
p = p + plot(data, nameColor="facies", name_size="connect")
...
p1 = p1 + plot(grid, name_raster="SimuPGS.1")
p1 = p1 + plot(data, nameColor="facies", name_size="connect")
p2 = ggDefaultGeographic()
p2 = p2 + plot(grid, name_raster="SimuPGS.2")
p2 = p2 + plot(data, nameColor="facies", name_size="connect")
p3 = ggDefaultGeographic()
p3 = p3 + plot(grid, name_raster="SimuPGS.3")
p3 = p3 + plot(data, nameColor="facies", name_size="connect")
p4 = ggDefaultGeographic()
p4 = p4 + plot(grid, name_raster="SimuPGS.4")
p4 = p4 + plot(data, nameColor="facies", name_size="connect")
