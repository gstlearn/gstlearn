...
varioparam = VarioParam_createOmniDirection(dpas=5, nlag=20)
...
p1 = ggDefaultGeographic() +
  plot(grid, nameRaster="SimuPGS.1", palette=cmap) +
  plot(data, nameColor="facies", nameSize="connect", palette=cmap)
p2 = ggDefaultGeographic() +
  plot(grid, nameRaster="SimuPGS.2", palette=cmap) +
  plot(data, nameColor="facies", nameSize="connect", palette=cmap)
p3 = ggDefaultGeographic() +
  plot(grid, nameRaster="SimuPGS.3", palette=cmap,) +
  plot(data, nameColor="facies", nameSize="connect", palette=cmap)
p4 = ggDefaultGeographic() +
  plot(grid, nameRaster="SimuPGS.4", palette=cmap) +
  plot(data, nameColor="facies", nameSize="connect", palette=cmap)
