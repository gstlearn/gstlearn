...
```{r, child="../../references/Variogram_Cloud.md"}
```
...
```{r, child="../../references/Experimental_Variogram.md"}
```
...
```{r, child="../../references/Directional_Variogram.md"}
```
...
```{r, child="../../references/Variogram_Map.md"}
```
