...
p3 = plot.init(asp=1) + plot.grid(grd, nameRaster = "homotopic.Z1", palette = "Spectral", 
                             flagLegendRaster = TRUE, legendNameRaster = "Z1")
p4 = plot.init(asp=1) + plot.grid(grd, nameRaster = "homotopic.Z2", palette = "Spectral", 
...
p3 = plot.init(asp=1) + plot.grid(grd, nameRaster = "heterotopic.Z1.heterotopic", 
                             palette = "Spectral", 
                             flagLegendRaster = TRUE, legendNameRaster = "Z1")
p4 = plot.init(asp=1) + plot.grid(grd, nameRaster = "heterotopic.Z2.heterotopic", 
                             palette = "Spectral", 
                             flagLegendRaster = TRUE, legendNameRaster = "Z2")
ggarrange(p1, p2, p3, p4, nrow = 2, ncol = 2)
```
