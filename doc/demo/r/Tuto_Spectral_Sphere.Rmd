...
nd = 100
spevec = cova$evalSpectrumOnSphere(nd)
plot.init() + 
...
err = simuSpectral(dbin=NULL, dbout=grd, model=modelSph, ns=ns, nd=nd, seed=seed, verbose=TRUE, 
...
err = simuSpectral(dbin = NULL, dbout = grd, model = modelSph, seed = 2584, ns=ns, nbsimu=nsim, 
                   namconv = NamingConvention(covname))
