...
plot.hist(data, name = "x1", color = "gray", fill = "orange")
plot.hist(data, name = "x2", color = "gray", fill = "skyblue")
plot.hist(data, name = "x3", color = "gray", fill = "green")
...
```{r}
# histograms and correlation
plot.hist(simu, name = "x1", color = "gray", fill = "orange")
plot.hist(simu, name = "x2", color = "gray", fill = "skyblue")
plot.hist(simu, name = "x3", color = "gray", fill = "green")
