...
```{r}
varioparam = VarioParam_createOmniDirection(nlag=10, dpas=0.1)
```
...
```{r}
ggplot() + plot.hscatter(db, "Simu.1", "Simu.2", varioparam, ilag=8, asPoint=TRUE, 
...
```{r}
ggplot() + plot.hscatter(db, "Simu.1", "Simu.2", varioparam, ilag=1, asPoint=FALSE, 
