...
```{r}
res = correlationPairs(db, db, "Simu.V1", "Simu.V2")
```



```{r}
plot.init() + plot.correlation(db, "Simu.V1", "Simu.V2", asPoint=TRUE,
...
```{r}
plot.init() + plot.correlation(db, "Simu.V1", "Simu.V2", asPoint=FALSE,
...
```{r}
plot.init() + plot.hscatter(db, "Simu.V1", "Simu.V2", varioparam, ilag=8, asPoint=TRUE,
...
```{r}
plot.init() + plot.hscatter(db, "Simu.V1", "Simu.V2", varioparam, ilag=1, asPoint=FALSE,
