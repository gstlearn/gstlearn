...
nbsimu = 4
iuid = simulateSPDE(NULL,grid,model,NULL,nbsimu)
grid
```
...
p1 = plot.init(asp=1) + plot.grid(grid, nameRaster="SimuSPDE.1")
p2 = plot.init(asp=1) + plot.grid(grid, nameRaster="SimuSPDE.2")
p3 = plot.init(asp=1) + plot.grid(grid, nameRaster="SimuSPDE.3")
p4 = plot.init(asp=1) + plot.grid(grid, nameRaster="SimuSPDE.4")
...
```{r Display_data}
plot.init() + plot.point(data, nameColor="data")
```
...
```{r Display_Kriging}
plot.init(asp=1) + plot.grid(grid, nameRaster="KrigingSPDE.data.estim")
```
...
nbsimu = 4
iuid = simulateSPDE(data,grid,model,NULL,nbsimu)
grid
```
...
p1 = plot.init(asp=1) + plot.grid(grid, nameRaster="SimuSPDE.data.1")
p2 = plot.init(asp=1) + plot.grid(grid, nameRaster="SimuSPDE.data.2")
p3 = plot.init(asp=1) + plot.grid(grid, nameRaster="SimuSPDE.data.3")
p4 = plot.init(asp=1) + plot.grid(grid, nameRaster="SimuSPDE.data.4")
ggarrange(p1, p2, p3, p4, ncol = 2, nrow = 2)
```
