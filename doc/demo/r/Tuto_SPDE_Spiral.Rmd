...
p1 = ggDefaultGeographic() + plot.grid(grid, name_raster="SimuSPDE.simu.1")
p2 = ggDefaultGeographic() + plot.grid(grid, name_raster="SimuSPDE.simu.2")
p3 = ggDefaultGeographic() + plot.grid(grid, name_raster="SimuSPDE.simu.3")
p4 = ggDefaultGeographic() + plot.grid(grid, name_raster="SimuSPDE.simu.4")
...
```{r Data_extraction}
data = Db_createSamplingDb(grid, number=100, names=c("x1", "x2", "SimuSPDE.simu.1"))
err = data$setName("*.simu.1", "data")
data
```

```{r Display_data}
ggDefaultGeographic() + plot.point(data, name_color="data")
```
...
```{r Display_Kriging}
ggDefaultGeographic() + plot.grid(grid, name_raster="KrigingSPDE.data.kriging")
```
...
p1 = ggDefaultGeographic() + plot.grid(grid, name_raster="SimuSPDE.data.condSimu.1")
p2 = ggDefaultGeographic() + plot.grid(grid, name_raster="SimuSPDE.data.condSimu.2")
p3 = ggDefaultGeographic() + plot.grid(grid, name_raster="SimuSPDE.data.condSimu.3")
p4 = ggDefaultGeographic() + plot.grid(grid, name_raster="SimuSPDE.data.condSimu.4")
ggarrange(p1, p2, p3, p4, ncol = 2, nrow = 2)
```
