...
p1 = plot.init(asp=1) + plot.raster(grid, name="SimuSPDE", version=0)
p2 = plot.init(asp=1) + plot.raster(grid, name="SimuSPDE", version=1)
p3 = plot.init(asp=1) + plot.raster(grid, name="SimuSPDE", version=2)
p4 = plot.init(asp=1) + plot.raster(grid, name="SimuSPDE", version=3)
...
```{r Data_extraction}
data = Db_createSamplingDb(grid, number=100, names=c("x1", "x2", "SimuSPDE"))
err = data$setName("SimuSPDE", "data")
data
```
...
p1 = plot.init(asp=1) + plot.raster(grid, name="SimuSPDE.data", version=0)
p2 = plot.init(asp=1) + plot.raster(grid, name="SimuSPDE.data", version=1)
p3 = plot.init(asp=1) + plot.raster(grid, name="SimuSPDE.data", version=2)
p4 = plot.init(asp=1) + plot.raster(grid, name="SimuSPDE.data", version=3)
ggarrange(p1, p2, p3, p4, ncol = 2, nrow = 2)
```
