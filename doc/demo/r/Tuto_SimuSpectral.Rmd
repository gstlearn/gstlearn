...
var_name = NamingConvention_getNameEncoded(prefix, NULL, 1, 1, 1, ns)
...
err = sim$computeSpectral(dbout = grid)
...
vl = list()
for (s in 1:ns) {
  err = grid$setLocator(name = NamingConvention_getNameEncoded(prefix, NULL, 1, 1, s, ns),
...
var_name = NamingConvention_getNameEncoded(prefix, NULL)
