...
var_name = getNameConstructed(prefix, NULL, 1, 1, 1, ns)
...
vl = list()
for (s in 1:ns) {
  err = grid$setLocator(name = getNameConstructed(prefix, NULL, 1, 1, s, ns),
...
var_name = getNameConstructed(prefix, NULL)
