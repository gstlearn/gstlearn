...
# using the simuSpectral interface
err  = simuSpectral(NULL, dbout = grid, model = mod, nbsimu = ns, ns = nb, seed=seed, cov0 = NULL, namconv = NamingConvention(prefix))
...
seed <- 3132
err = simuSpectral(NULL, grid1, mod, 1, nb, seed=seed , namconv = NamingConvention(prefix))
err = simuSpectral(NULL, grid2, mod, 1, nb, seed=seed , namconv = NamingConvention(prefix))
...
err = simuSpectral(NULL, db, mod, 1, nb, seed=seed , namconv = NamingConvention(prefix))
...
err = simuSpectral(NULL, grid, mod, 1, nb, seed=seed , namconv = NamingConvention(prefix))
