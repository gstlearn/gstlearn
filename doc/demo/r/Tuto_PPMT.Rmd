...
plot(q1, q2, xlab = "Experimental quantiles", ylab = "Theoretical quantiles", main = "First Intial Variable")
abline(a = 0, b = 1, col = "red", lty = 3)

# Second components
q1 = VectorHelper_quantiles(data$getColumns("Y2"), probas)
plot(q1, q2, xlab = "Experimental quantiles", ylab = "Theoretical quantiles", main = "Second Intial Variable")
abline(a = 0, b = 1, col = "red", lty = 3)
...
plot.correlation(simu, name1 = "Y1", name2 = "Y2", flagDiag = TRUE, xlab = "Y1", ylab = "Y2", 
                 title = "Initial Gaussian variables (simulation)")

# Back-tranform of the simulated Gaussian variables
plot.correlation(simu, name1 = "Z.Y1", name2 = "Z.Y2", flagDiag = TRUE, xlab = "Z1", ylab = "Z2", 
                 title = "Simulations of the raw variables")
