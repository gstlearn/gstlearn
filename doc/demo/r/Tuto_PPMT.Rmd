...
p = ggplot()
p = p + plot.correlation(grd, name1 = "Y1", name2 = "Y2", bins=100, flagDiag = TRUE)
...
p = ggplot()
p = p + plot.correlation(grd, name1 = "Z1", name2 = "Z2", bins=100, flagDiag = TRUE)
...
p = ggplot()
p = p + plot.correlation(data, name1 = "Z1", name2 = "Z2", bins=100, flagDiag = TRUE)
...
p = ggplot()
p = p + plot.correlation(simu, name1 = "Y1", name2 = "Y2", bins=100, flagDiag = TRUE)
p = p + plot.decoration(title = "Initial Gaussian variables (simulation)")
ggPrint(p)

# Back-tranform of the simulated Gaussian variables
p = ggplot()
p = p + plot.correlation(simu, name1 = "Z.Y1", name2 = "Z.Y2", bins=100, flagDiag = TRUE)
