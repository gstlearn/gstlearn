...
plot.hist(grd, name = "Y1", color = "gray", fill = "orange")
plot.hist(grd, name = "Y2", color = "gray", fill = "skyblue")
...
# histograms and correlation
plot.hist(grd, name = "Z1", color = "gray", fill = "orange")
plot.hist(grd, name = "Z2", color = "gray", fill = "skyblue")
...
# histograms and correlation
plot.hist(data, name = "Z1", color = "gray", fill = "orange")
plot.hist(data, name = "Z2", color = "gray", fill = "skyblue")
