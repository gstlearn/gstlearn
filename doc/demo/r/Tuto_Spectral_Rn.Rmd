...
err = simuSpectral(NULL, grid, mod, nbsimu = ns, ns=nb, seed=seed,
                   namconv = NamingConvention("S")) 
```
...
err = sims$simulate(ns = nb, seed = seed)
...
err = simuSpectral(NULL, grid, mod, ns=nb, seed=seed, namconv = NamingConvention("S1"))
```
