...
# plot
p1 = plot.init(asp=1) + plot.grid(grid, nameRaster="spde.1", palette = "Spectral")
p2 = plot.init(asp=1) + plot.grid(grid, nameRaster="spde.2", palette = "Spectral")
p3 = plot.init(asp=1) + plot.grid(grid, nameRaster="spde.3", palette = "Spectral")
p4 = plot.init(asp=1) + plot.grid(grid, nameRaster="spde.4", palette = "Spectral")
...
# plot
p1 = plot.init(asp=1) + plot.grid(grid, nameRaster="spde.Z.1", palette = "Spectral")
p2 = plot.init(asp=1) + plot.grid(grid, nameRaster="spde.Z.2", palette = "Spectral")
p3 = plot.init(asp=1) + plot.grid(grid, nameRaster="spde.Z.3", palette = "Spectral")
p4 = plot.init(asp=1) + plot.grid(grid, nameRaster="spde.Z.4", palette = "Spectral")
ggarrange(p1, p2, p3, p4, ncol = 2, nrow = 2)
```
...
p1 = plot.init(asp=1) + plot.grid(grid, nameRaster="spdeK.Z.estim", palette = "Spectral")
p2 = plot.init(asp=1) + plot.grid(grid, nameRaster="spdeK.Z.stdev", palette = "Spectral")
...
# plot
p1 = plot.init(asp=1) + plot.grid(grid, nameRaster="spde.fn.1", palette = "Spectral")
p2 = plot.init(asp=1) + plot.grid(grid, nameRaster="spde.fn.2", palette = "Spectral")
p3 = plot.init(asp=1) + plot.grid(grid, nameRaster="spde.fn.3", palette = "Spectral")
p4 = plot.init(asp=1) + plot.grid(grid, nameRaster="spde.fn.4", palette = "Spectral")
ggarrange(p1, p2, p3, p4, ncol = 2, nrow = 2)
```
...
# plot
p1 = plot.init(asp=1) + plot.grid(grid, nameRaster="spde.fn.Z.1", palette = "Spectral")
p2 = plot.init(asp=1) + plot.grid(grid, nameRaster="spde.fn.Z.2", palette = "Spectral")
p3 = plot.init(asp=1) + plot.grid(grid, nameRaster="spde.fn.Z.3", palette = "Spectral")
p4 = plot.init(asp=1) + plot.grid(grid, nameRaster="spde.fn.Z.4", palette = "Spectral")
ggarrange(p1, p2, p3, p4, ncol = 2, nrow = 2)
```
...
err = krigingSPDE(dbin = dat, dbout = grid, model = model, 
                  flag_est = TRUE, flag_std = TRUE, nbMC=0,
                  namconv = NamingConvention("spde.fn"))
