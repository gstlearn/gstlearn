...
p = ggDefault() + 
    plot.correlation(db1 = grid, namex = "manual.kriging", namey = "manual.simu", asPoint = FALSE, 
                     flagDiag = TRUE, diag_color = "red", flagSameAxes = FALSE, bins=100) +
...
# plot
p = ggDefaultGeographic() + 
    plot.grid(grid, name_raster = "spde", useSel = TRUE, 
            show.legend.raster = TRUE, palette = "Spectral") +
  plot.decoration(xlab = "Easting", ylab = "Northing", 
...
p = ggDefault() + 
    plot.correlation(grid, namex = "spde.kriging", namey = "manual.simu",asPoint = FALSE,
                     flagDiag = TRUE, diag_color = "red", flagRegr = TRUE, 
                     regr_color = "black", regr_line = 2,
