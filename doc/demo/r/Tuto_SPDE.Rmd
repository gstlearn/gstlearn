...
p = ggDefault() + 
    plot.correlation(db1 = grid, namex = "manual.kriging", namey = "manual.cond.simu", asPoint = FALSE, 
                     flagDiag = TRUE, diag_color = "red", flagSameAxes = FALSE) +
...
p = ggDefault() + 
    plot.correlation(db1 = grid, namex = "manual.cond.expectation", namey = "manual.kriging", asPoint = FALSE, 
                     flagDiag = TRUE, diag_color = "red", flagSameAxes = FALSE) +
