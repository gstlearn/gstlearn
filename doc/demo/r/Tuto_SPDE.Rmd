...
p2 = ggDefaultGeographic() + 
    plot.grid(grid, name_raster = "manual.cond.std", useSel = TRUE, palette = "Spectral", 
            show.legend.raster = TRUE) +
    # plot.point(dat, col = "red") +
    plot.decoration(xlab = "Easting", ylab = "Northing", 
...
# plot
p1 = ggDefaultGeographic() + plot.grid(grid, name_raster="spde.simu.1", palette = "Spectral")
p2 = ggDefaultGeographic() + plot.grid(grid, name_raster="spde.simu.2", palette = "Spectral")
p3 = ggDefaultGeographic() + plot.grid(grid, name_raster="spde.simu.3", palette = "Spectral")
p4 = ggDefaultGeographic() + plot.grid(grid, name_raster="spde.simu.4", palette = "Spectral")
...
err = grid$deleteColumns(names = "spde.Z.condSimu.*")
...
err = grid$deleteColumns(names = c("spde.Z.kriging", "spde.Z.stdev"))

# kriging value
spdeRes = SPDE(model = model_obs, domain = gridExt, data = dat, calcul = ESPDECalcMode_KRIGING(), mesh = mesh)
iuid    = spdeRes$compute(grid, namconv = NamingConvention("spde"))

# computing the stdev by Monte Carlo
tab = matrix(grid$getColumns(names = "spde.Z.condSimu.*", useSel = FALSE), 
             nrow = grid$getSampleNumber(FALSE), ncol = nsim)
val_std = apply(X = tab, MARGIN = 1, FUN = sd)
err = grid$setColumn(tab = val_std, name = "spde.Z.stdev", useSel = FALSE)

# plot of Z* ans Std. of the kriging error (Z - Z*)
p1 = ggDefaultGeographic() + plot.grid(grid, name_raster="spde.Z.kriging", palette = "Spectral")
p2 = ggDefaultGeographic() + plot.grid(grid, name_raster="spde.Z.stdev", palette = "Spectral")
ggarrange(p1, p2, ncol = 2, nrow = 2)

# cross plot for kriging values
p = ggDefault() + 
    plot.correlation(db1 = grid, name1 = "manual.kriging", name2 = "spde.Z.kriging", asPoint = FALSE, 
                     flagDiag = TRUE, diag_color = "red", flagSameAxes = FALSE) +
...
# plot
p1 = ggDefaultGeographic() + plot.grid(grid, name_raster="spde.fn.simu.1", palette = "Spectral")
p2 = ggDefaultGeographic() + plot.grid(grid, name_raster="spde.fn.simu.2", palette = "Spectral")
p3 = ggDefaultGeographic() + plot.grid(grid, name_raster="spde.fn.simu.3", palette = "Spectral")
p4 = ggDefaultGeographic() + plot.grid(grid, name_raster="spde.fn.simu.4", palette = "Spectral")
ggarrange(p1, p2, p3, p4, ncol = 2, nrow = 2)
...
# plot
p1 = ggDefaultGeographic() + plot.grid(grid, name_raster="spde.fn.Z.condSimu.1", palette = "Spectral")
p2 = ggDefaultGeographic() + plot.grid(grid, name_raster="spde.fn.Z.condSimu.2", palette = "Spectral")
p3 = ggDefaultGeographic() + plot.grid(grid, name_raster="spde.fn.Z.condSimu.3", palette = "Spectral")
p4 = ggDefaultGeographic() + plot.grid(grid, name_raster="spde.fn.Z.condSimu.4", palette = "Spectral")
ggarrange(p1, p2, p3, p4, ncol = 2, nrow = 2)
...
# cross plot for kriging values
p = ggDefault() + 
    plot.correlation(db1 = grid, name1 = "manual.kriging", name2 = "spde.fn.Z.kriging", asPoint = FALSE, 
                     flagDiag = TRUE, diag_color = "red", flagSameAxes = FALSE) +
