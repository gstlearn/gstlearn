...
mydirs = DirParam_createMultiple(4, dpas=1., npas=10)
...
err = myModelConstrained$fit(myVarioOmni,ECov_fromValues(c(1,2)),constr)
myModelConstrained
```
...
We initiate a Neigbourhood (Moving with a small number of samples for Demonstration)
