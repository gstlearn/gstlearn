...
```{r}
p = plot.XY(zz_theo, zz_hm, join=TRUE, flagDiag=TRUE, color = "blue")
...
p = plot.XY(zz_theo, zz_rg, join=TRUE, flagDiag=TRUE, color="blue")
p = plot5decoration(p, xlab="theoretical", ylab="Hermite pol.", title="Lognormal Transform")
p
