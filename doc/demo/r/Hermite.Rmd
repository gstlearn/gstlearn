...
draw.matrix <- function(type,calcul,flag.est,params,flag.cut=TRUE)
{
  ...
  p = ggplot()
  p = p + plot.grid(db,name_raster="psi")
...
p = ggplot()
p = p + plot.XY(yy, zz_theo, join=TRUE, color = "red")
p = p + plot.XY(yy, zz_hm, color = "blue", linetype="dashed")
...
```{r}
p = ggplot()
p = p + plot.XY(zz_theo, zz_hm, join=TRUE, color = "blue")
...
p = ggplot()
p = p + plot.XY(r, C_theo(r), color = "red", join=TRUE)
p = p + plot.XY(r,C_nh(r), join=TRUE, color = "blue", linetype="dashed")
...
p = p + plot.XY(yy, zz_theo, color="red", linetype="dashed")
...
p = ggplot()
p = p + plot.XY(r, cov_theo, color = "red", join=TRUE) 
p = p + plot.XY(r, cov_rg, color = "blue", linetype = "dashed")
...
ylim = c(-3.5, 3.5)
p = ggplot()
p = p + plot.XY(yy, zz, join=TRUE, color = "red")
p = p + plot.XY(yy, pmax(yc, yy), color = "blue", join=TRUE, linetype = "dashed")
...
p = p + plot.XY(yy, as.numeric(yy >= yc), color = "blue", join=TRUE, linetype="dashed")
ggPrint(p)
