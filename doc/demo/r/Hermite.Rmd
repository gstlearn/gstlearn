...
The next line is the dedicated code which launches the version of Geoslib which has been made available through the *swig* mechanism. It will be modified as soon as rgstlearn becomes an official R package.

```{r, message=FALSE, warning=FALSE}
if ("package.RGeostats" %in% (.packages())) { detach("package.RGeostats",force=TRUE) }
if ("gstlearn" %in% (.packages())) { detach("gstlearn",force=TRUE) }
