...
# kriging in unique neighbourhood
  ...
  p = ggplot() + 
    plot.correlation(grid, namex = "kriging.Z.estim", namey = "SPDE.Z.kriging", 
  ...
  # estimate by MC
  p = ggplot() + 
    plot.correlation(grid, namex = "SPDE.Z.kriging", namey = "SPDE.Z.estim", 
                     flagDiag = TRUE, diag_color = "red", flagSameAxes = TRUE) +
  ...
  # stdev
  p = ggplot() + 
    plot.correlation(grid, namex = "kriging.Z.stdev", namey = "SPDE.Z.stdev", 
                     flagDiag = TRUE, diag_color = "red", flagSameAxes = TRUE) +
