...
# kriging in unique neighborhood
  ...
  p = ggplot() + 
    plot.correlation(grid, namex = "kriging.Z.estim", namey = "SPDE.Z.estim", 
                     flagDiag = TRUE, diag_color = "red", flagSameAxes = TRUE, bins=100) +
  ...
  p2 = ggDefaultGeographic() + 
    plot.grid(grid, name_raster = "SPDE.Z.estim", 
  ...
  p1 = ggDefaultGeographic() + 
    ...
    plot.decoration(xlab = "Easting", ylab = "Northing")
  p2 = ggDefaultGeographic() + 
    plot.grid(grid, name_raster = "SPDE.ZMC.stdev", 
              palette = "Spectral", show.legend.raster = TRUE, legend.name.raster = "SPDE") +
    plot.decoration(xlab = "Easting", ylab = "Northing")
  ggarrange(p1, p2, nrow = 1, ncol = 2)
```
...
# kriging in unique neighbourhood
  ...
  p1 = ggDefaultGeographic() + 
    ...
    plot.decoration(xlab = "Easting", ylab = "Northing")
  p2 = ggDefaultGeographic() + 
    plot.grid(grid, name_raster = "SPDE.ZMC.estim", 
              palette = "Spectral", show.legend.raster = TRUE, legend.name.raster = "SPDE") +
    plot.decoration(xlab = "Easting", ylab = "Northing")
  ggarrange(p1, p2, nrow = 1, ncol = 2)
