...
plot.init(asp=1) + plot.grid(grid,nameRaster="fac",flagLegendRaster=TRUE)
```
...
grid$display()
plot.init(asp=1) + plot.grid(grid,nameRaster="Indicator.fac.Class.4",flagLegendRaster=TRUE)
```
